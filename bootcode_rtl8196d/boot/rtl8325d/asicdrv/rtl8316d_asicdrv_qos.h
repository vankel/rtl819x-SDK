...
/*to be implemented*/
extern int32 rtk_port_phyForceModeAbility_set(rtk_port_t port, rtk_port_phy_ability_t *pAbility);
extern int32 rtk_port_phyForceModeAbility_get(rtk_port_t port, rtk_port_phy_ability_t *pAbility);
extern int32 rtk_port_phyStatus_get(rtk_port_t port, rtk_port_linkStatus_t *pLinkStatus, rtk_port_speed_t *pSpeed, rtk_port_duplex_t *pDuplex);
...
extern int32 rtk_port_backpressureEnable_set(rtk_port_t port, rtk_enable_t enable); 
extern int32 rtk_port_adminEnable_set(rtk_port_t port, rtk_enable_t enable);//ask Aaron
