...
struct smp_boot {
	unsigned long	pc;	/* unused in arm */
	unsigned long	gp;	/* unused in arm */
	unsigned long	sp;	/* unused in arm */
	unsigned long	a0;	/* unused in arm */
...
#define SMPBOOT			0x00003f00

/* Polling period in count cycles for secondary CPU's */
#define SMP_LAUNCH_PERIOD	10000

extern int amon_cpu_avail(int);
extern void amon_cpu_start(int, unsigned long);
