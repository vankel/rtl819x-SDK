...
MIBDEF(unsigned char,	macAddr, [6],	WLAN_FTKH_MACADDR,	BYTE6_T, FTKH_T, 0, 0)
MIBDEF(unsigned char,	nas_id, [50],	WLAN_FTKH_NAS_ID,	STRING_T, FTKH_T, 0, 0)
MIBDEF(unsigned char,	key, [36],	WLAN_FTKH_KEY,	STRING_T, FTKH_T, 0, 0)
#ifdef DOT11K
MIBDEF(unsigned char,	opclass, ,	WLAN_FTKH_OPCLASS,	BYTE_T, FTKH_T, 0, 0)
MIBDEF(unsigned char,   channel, ,  WLAN_FTKH_CHANNEL,  BYTE_T, FTKH_T, 0, 0)
#endif //DOT11K
...
#ifdef FAST_BSS_TRANSITION
MIBDEF(unsigned char,	ft_enable, ,	FT_ENABLE,	BYTE_T, CONFIG_WLAN_SETTING_T, 0, 0)
MIBDEF(unsigned char,	ft_mdid, [COMMENT_LEN],	FT_MDID,	STRING_T, CONFIG_WLAN_SETTING_T, 0, 0)
MIBDEF(unsigned char,	ft_over_ds, ,	FT_OVER_DS,	BYTE_T, CONFIG_WLAN_SETTING_T, 0, 0)
MIBDEF(unsigned char,	ft_res_request, ,	FT_RES_REQUEST,	BYTE_T, CONFIG_WLAN_SETTING_T, 0, 0)
MIBDEF(unsigned int,	ft_r0key_timeout, ,	FT_R0KEY_TO,	DWORD_T, CONFIG_WLAN_SETTING_T, 0, 0)
MIBDEF(unsigned int,	ft_reasoc_timeout, ,	FT_REASOC_TO,	DWORD_T, CONFIG_WLAN_SETTING_T, 0, 0)
MIBDEF(unsigned char,	ft_r0kh_id, [COMMENT_LEN],	FT_R0KH_ID,	STRING_T, CONFIG_WLAN_SETTING_T, 0, 0)
MIBDEF(unsigned char,	ft_push, ,	FT_PUSH,	BYTE_T, CONFIG_WLAN_SETTING_T, 0, 0)

MIBDEF(unsigned char,	ftkhNum, ,	FTKH_NUM,	BYTE_T, CONFIG_WLAN_SETTING_T, 0, 0)
MIBDEF(FTKH_T,	khArray, [MAX_FTKH_NUM],	FTKH,	FTKH_ARRAY_T, CONFIG_WLAN_SETTING_T, 0, wlan_ftkh_tbl)
#endif
//=========add for MESH=========
...
#ifdef STA_CONTROL
MIBDEF(unsigned char,	stactrl_enabled, ,	STACTRL_ENABLE,	BYTE_T, CONFIG_WLAN_SETTING_T, 0, 0)
MIBDEF(unsigned char,   stactrl_prefer, ,  STACTRL_PREFER,    BYTE_T, CONFIG_WLAN_SETTING_T, 0, 0)
#endif
