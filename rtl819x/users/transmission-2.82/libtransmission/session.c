...
tr_sessionGetDefaultSettings (tr_variant * d)
{
  ...
  tr_variantDictAddStr  (d, TR_KEY_download_dir,                    "/home/");
//tr_variantDictAddStr  (d, TR_KEY_download_dir,                    tr_getDefaultDownloadDir ());
  tr_variantDictAddInt  (d, TR_KEY_speed_limit_down,                500);
  ...
  tr_variantDictAddBool (d, TR_KEY_rpc_authentication_required,     true);
  tr_variantDictAddStr  (d, TR_KEY_rpc_bind_address,                "0.0.0.0");
  tr_variantDictAddBool (d, TR_KEY_rpc_enabled,                     false);
  tr_variantDictAddStr  (d, TR_KEY_rpc_password,                    "admin");
  tr_variantDictAddStr  (d, TR_KEY_rpc_username,                    "admin");
