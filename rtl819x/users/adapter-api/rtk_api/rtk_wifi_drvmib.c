...
static void drvmib_release_rtkapi()
{
	int i;
...
{
	struct wifi_mib* pmib = _wlanMibs[i];
	int opmode;
	...
	if( pmib->gbwcEntry.GBWThrd_rx==0 ){
		if( pmib->gbwcEntry.GBWThrd_tx==0 ){
