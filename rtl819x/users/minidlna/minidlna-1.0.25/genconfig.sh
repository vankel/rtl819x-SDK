...
[ ! -e "$DLNA_INSTALL_PREFIX/include/sqlite3.h" ] && MISSING="libsqlite3 $MISSING"
[ ! -e "$DLNA_INSTALL_PREFIX/include/jpeglib.h" ] && MISSING="libjpeg $MISSING"
[ ! -e "$DLNA_INSTALL_PREFIX/include/libexif/exif-loader.h" ] && MISSING="libexif $MISSING"
[ ! -e "$DLNA_INSTALL_PREFIX/include/id3tag.h" ] && MISSING="libid3tag $MISSING"
#[ ! -e "$DLNA_INSTALL_PREFIX/include/ogg/ogg.h" ] && MISSING="libogg $MISSING"
#[ ! -e "$DLNA_INSTALL_PREFIX/include/vorbis/codec.h" ] && MISSING="libvorbis $MISSING"
#[ ! -e "$DLNA_INSTALL_PREFIX/include/FLAC/metadata.h" ] && MISSING="libflac $MISSING"
[ ! -e "$DLNA_INSTALL_PREFIX/include/ffmpeg/avutil.h" -a \
  ! -e "$DLNA_INSTALL_PREFIX/include/libavutil/avutil.h" -a \
  ! -e "$DLNA_INSTALL_PREFIX/include/ffmpeg/libavutil/avutil.h" ] && MISSING="libavutil $MISSING"
[ ! -e "$DLNA_INSTALL_PREFIX/include/ffmpeg/avformat.h" -a \
  ! -e "$DLNA_INSTALL_PREFIX/include/libavformat/avformat.h" -a \
  ! -e "$DLNA_INSTALL_PREFIX/include/ffmpeg/libavformat/avformat.h" ] && MISSING="libavformat $MISSING"
[ ! -e "$DLNA_INSTALL_PREFIX/include/ffmpeg/avcodec.h" -a \
  ! -e "$DLNA_INSTALL_PREFIX/include/libavcodec/avcodec.h" -a \
  ! -e "$DLNA_INSTALL_PREFIX/include/ffmpeg/libavcodec/avcodec.h" ] && MISSING="libavcodec $MISSING"
if [ -n "$MISSING" ]; then
...
#if [ -f $DLNA_INSTALL_PREFIX/include/inotify.h ]; then
...
if [ -f $DLNA_INSTALL_PREFIX/include/iconv.h ]; then
...
if [ -f $DLNA_INSTALL_PREFIX/include/libintl.h ]; then
