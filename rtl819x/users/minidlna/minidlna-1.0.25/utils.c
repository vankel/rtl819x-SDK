...
is_video(const char * file)
{
	return (ends_with(file, ".mpg") || ends_with(file, ".mpeg")  ||
		...
		ends_with(file, ".asf") || ends_with(file, ".avc") ||
		ends_with(file, ".dv") || ends_with(file, ".mjpeg") ||
		ends_with(file, ".mpe") || ends_with(file, ".mjpg") ||
		ends_with(file, ".m1v") || ends_with(file, ".ogm") ||
		ends_with(file, ".mp2p") || ends_with(file, ".mp2t") ||
		ends_with(file, ".m2v") || ends_with(file, ".mpg2") ||
		ends_with(file, ".mpeg2") || ends_with(file, ".bin") ||
		ends_with(file, ".iso") || ends_with(file, ".m4p") ||
		ends_with(file, ".mp4ps") || ends_with(file, ".hdmov") ||
		ends_with(file, ".qt") || 
#ifdef TIVO_SUPPORT
		ends_with(file, ".TiVo") ||
#endif
