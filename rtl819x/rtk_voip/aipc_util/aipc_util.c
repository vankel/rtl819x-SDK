...
int main( int argc, char *argv[])
{
    ...
    for (;;) {
        int option_index = 0;
        static const char *short_options = "hwrbupzemISR:d:s:i:l:o:W:A:O:X:N:t:D:C:F:";
...
int display_help(void)
{
	...
	printf("aipc_util -w -d 0xb0000000 -s 0xbd510000 -l 0x10000 -p	//add padding in tail\n");
	printf("aipc_util -w -d 0xb0000000 -i /home/aipc_test   //write /home/aipc_test to 0xb0000000\n");
	...
	printf("\nRead operation\n");
	printf("aipc_util -r -d 0xb0000000 -o ./8M.out  -l 0x800000 //read 8MB from 0xb0000000 \n");
	...
	printf("\nMisc\n");
	printf("aipc_util -z   		//setup zone\n");
	printf("aipc_util -e   		//setup entry\n");
	printf("aipc_util -b   		//boot_dsp\n");
	printf("aipc_util -u   		//unmap_dram\n");
	printf("aipc_util -t 1|0	//trigger dsp|cpu\n");
	printf("aipc_util -R   		//setup ROM\n");
	return OK;
}
