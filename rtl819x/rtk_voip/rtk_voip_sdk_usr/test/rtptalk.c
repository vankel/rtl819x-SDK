...
int main(int argc, char *argv[])
{
	...
	stVoipMgrSession.rfc2833_dtmf_pt_local= 96;
	stVoipMgrSession.rfc2833_dtmf_pt_remote= 96;
	stVoipMgrSession.rfc2833_fax_modem_pt_local= 96;
	stVoipMgrSession.rfc2833_fax_modem_pt_remote= 96;
	...
	stVoipPayLoadTypeConfig.uLocalPktFormat = atoi(argv[3]);
	stVoipPayLoadTypeConfig.uRemotePktFormat = atoi(argv[3]);
	stVoipPayLoadTypeConfig.nG723Type = 0;
	stVoipPayLoadTypeConfig.nLocalFramePerPacket = 2;
	stVoipPayLoadTypeConfig.nRemoteFramePerPacket = 2;
