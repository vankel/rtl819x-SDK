#ifndef __BASE_GPIO_89XXD_H__
#define __BASE_GPIO_89XXD_H__
...
#define I2C_SCLK_PIN		GPIO_ID(GPIO_PORT_F,2)	//output
#define I2C_SDIO_PIN		GPIO_ID(GPIO_PORT_F,1)	//output or input
#elif defined(CONFIG_RTK_VOIP_DRIVERS_CODEC_ALC5633Q)
#define I2C_SCLK_PIN		GPIO_ID(GPIO_PORT_B,6)	//output
#define I2C_SDIO_PIN		GPIO_ID(GPIO_PORT_B,5)	//output or input
#endif

//----------------------- GPIO API mapping ----------------------------------------------
#define __i2c_initGpioPin( id, dir, intt ) 	\
			_rtl8972D_initGpioPin( id, GPIO_CONT_GPIO, dir, intt )
#define __i2c_getGpioDataBit( id, pd )		\
			_rtl8972D_getGpioDataBit( id, pd )
#define __i2c_setGpioDataBit( id, d )		\
			_rtl8972D_setGpioDataBit( id, d )
