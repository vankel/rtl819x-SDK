...
#if 0
#ifdef RTK_VOIP_GPIO_IPP_89XXD_CODEC 
...
void ipphone_hook_interrupt( int enable )
{
	...
	_rtl8972D_initGpioPin( IPPHONE_PIN_HOOK, GPIO_CONT_GPIO, GPIO_DIR_IN, int_type );
#endif
}
...
void init_ipphone_hook_detect( void )
{
  ...
  #else
	_rtl8972D_initGpioPin( IPPHONE_PIN_HOOK, GPIO_CONT_GPIO, GPIO_DIR_IN, GPIO_INT_DISABLE );
  #endif
#endif
}
...
#ifdef RTK_VOIP_GPIO_IPP_89XXD_CODEC 
  #ifdef IPPHONE_PIN_HOOK
	_rtl8972D_getGpioDataBit( IPPHONE_PIN_HOOK, &data );
  #else
