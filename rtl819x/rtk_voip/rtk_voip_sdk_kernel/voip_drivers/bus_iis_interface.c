...
#elif defined(CONFIG_RTK_VOIP_DRIVERS_PCM89xxC) || defined(CONFIG_RTK_VOIP_DRIVERS_PCM89xxD) || defined(CONFIG_RTK_VOIP_DRIVERS_PCM89xxE)
#define BIST_CONTROL	0xb8000014
#define LOCK_LX2_BUS	(1<<4)
#define BIST_DONE	0xb8000020
#define LOCK_LX2_OK	(1<<2)
#endif /* (CONFIG_RTK_VOIP_DRIVERS_PCM8972B_FAMILY) || (CONFIG_RTK_VOIP_DRIVERS_PCM89xxC) || (CONFIG_RTK_VOIP_DRIVERS_PCM89xxD) || (CONFIG_RTK_VOIP_DRIVERS_PCM89xxE)*/
