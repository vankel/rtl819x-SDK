...
#elif defined(CONFIG_RTK_VOIP_DRIVERS_PCM89xxE)
#ifdef CONFIG_RTK_VOIP_DRIVERS_PCM8954E_CPU0
#define RTK_GPIO_INIT(pid, dedicate, dir, interrupt)  _rtl8954E_initGpioPin(pid, dedicate, dir, interrupt)
#define RTK_GPIO_GET(pid, pData) _rtl8954E_getGpioDataBit(pid, pData) 
#define RTK_GPIO_SET(pid, data) _rtl8954E_setGpioDataBit(pid, data)
