 ...
 *
 * $Revision: 11088 $
 * $LastChangedDate: 2013-07-24 09:32:46 -0500 (Wed, 24 Jul 2013) $
 */
    ...
    VpDevCtxType *pDevCtx)
{
    ...
    /* IN PROGRESS */
        ...
        if (queueSize > 0) {
            ...
            if (pDevObj->debugSelectMask & VP_DBG_ERROR) {
    ...
    VpDevCtxType *pDevCtx)
{
    ...
    /* Force both channels to active */
    VpSlacRegWrite(pDevCtx, NULL, VP886_R_STATE_WRT, VP886_R_STATE_LEN, slacState);

    /* Place both IO2 pins in V monitor mode, calibration currents get affected by the IO pins... */
    ...
    VpLineCtxType *pLineCtx)
{
    ...
    switch (pLineObj->calLineSubState) {
        case VP886_VADC_INIT:
            ...
            opCond = pDevObj->regPad[channelId].opCond[0] | VP886_R_OPCOND_HIGHPASS;
    ...
    VpLineCtxType *pLineCtx)
{
    ...
    VpMemCpy(pLineObj->registers.icr2, pDevObj->regPad[channelId].icr3, VP886_R_ICR3_LEN);
    VpSlacRegWrite(NULL, pLineCtx, VP886_R_ICR3_WRT, VP886_R_ICR3_LEN, pLineObj->registers.icr3);
    VpMemCpy(pLineObj->registers.icr2, pDevObj->regPad[channelId].icr4, VP886_R_ICR4_LEN);
