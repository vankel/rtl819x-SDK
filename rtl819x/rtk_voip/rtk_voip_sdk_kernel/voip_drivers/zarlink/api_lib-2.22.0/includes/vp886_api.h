 ...
 *
 * $Revision: 11101 $
 * $LastChangedDate: 2013-07-31 10:33:35 -0500 (Wed, 31 Jul 2013) $
 */
...
//#define VP886_EVENT_QUEUE_SIZE 12
...
/* Vp886InitDeviceSM() state variable */
typedef enum {
 ...
 */
typedef struct Vp886LineObjectType {
    uint8 channelId;
    VpLineIdType lineId;
    VpTermType termType;
    uint8 ecVal;
    ...
    /* These flags are used by Vp886IsReady() to decide whether a line can be
    ...
    /* Ringing bias and amplitude from the ringing profile, used to apply
       calibration. */
    int16 ringBias;
    int16 ringAmplitude;
 ...
 */
typedef struct Vp886DeviceObjectType {
