 ...
 *
 * $Revision: 11129 $
 * $LastChangedDate: 2013-08-14 20:43:58 -0500 (Wed, 14 Aug 2013) $
 */
    ...
    switch (option) {
        ...
        case VP_OPTION_ID_RINGING_PARAMS: {
            ...
            pOptionData->ringingParams.dcBias =
                (int32)((((uint16)(ringingValues[VP890_SIGA_BIAS_MSB]) << 8) & 0xFF00) |
                         ((uint16)(ringingValues[VP890_SIGA_BIAS_LSB]) & 0x00FF));
            pOptionData->ringingParams.dcBias *= 4712; /* VP890_RINGING_BIAS_SCALE; */
            ...
            if ((ringingValues[0] & VP890_SIGGEN1_SINTRAP_MASK)  == VP890_SIGGEN1_TRAP) {
                ...
                pOptionData->ringingParams.frequency =
                    (int32)((((uint16)ringingValues[VP890_SIGB_FREQ_MSB] << 8) & 0xFF00) |
                            (((uint16)ringingValues[VP890_SIGB_FREQ_LSB]) &0x00FF));
                ...
                pOptionData->ringingParams.trapRiseTime = 
                    (int32)((((uint16)ringingValues[VP890_SIGA_FREQ_MSB] << 8) & 0xFF00) |
                            (((uint16)ringingValues[VP890_SIGA_FREQ_LSB]) &0x00FF));
                ...
                pOptionData->ringingParams.frequency =
                    (int32)((((uint16)ringingValues[VP890_SIGA_FREQ_MSB] << 8) & 0xFF00) |
                            (((uint16)ringingValues[VP890_SIGA_FREQ_LSB]) &0xFF));
                /* Frequency is in 0.3662Hz. Multiply by 3662 / 10 gives mHz */
                pOptionData->ringingParams.frequency *= 3662; /* VP890_GENA_FREQ_STEPSIZE; */
            ...
            pOptionData->ringingParams.amplitude = 
                (int32)((((uint16)ringingValues[VP890_SIGA_AMP_MSB] << 8) & 0xFF00) |
                        (((uint16)ringingValues[VP890_SIGA_AMP_LSB]) &0x00FF));
            pOptionData->ringingParams.amplitude *= 4730; /* VP890_RINGING_AMP_SCALE; */
            ...
            pOptionData->ringingParams.ringTripThreshold =                 
                ((int32)(pLineObj->calLineData.loopSup[VP890_LOOP_SUP_RT_MODE_BYTE] 
                  & VP890_LOOP_SUP_RT_MODE_THRSHLD) * 500);
            
            /* Compute the Ringing Current Limit :: 50-112mA, step = 2mA */
            pOptionData->ringingParams.ringCurrentLimit = 
                ((pLineObj->calLineData.loopSup[VP890_LOOP_SUP_RING_LIM_BYTE] 
                  & VP890_LOOP_SUP_RING_LIM_MASK) + 25); /* Add 25 = 50mA / 2mA */                     
            /* Convert to uA */
