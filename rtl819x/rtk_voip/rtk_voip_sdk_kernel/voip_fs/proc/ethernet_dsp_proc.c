...
int voip_get_ethernet_dsp_info_proc_read( struct seq_file *m, void *data )
{
#ifdef IPC_ARCH_DEBUG_HOST
	int i;
#endif
...
#ifdef CONFIG_LINUX_KERNEL_3_10
static int voip_get_ethernet_dsp_info_proc_open(struct inode *inode, struct file *file)
{
	return single_open(file, voip_get_ethernet_dsp_info_proc_read, NULL);
}

static const struct file_operations get_ethernet_dsp_info_fops = 
{
	.open = voip_get_ethernet_dsp_info_proc_open,
	.read = seq_read,
	.llseek = seq_lseek,
};
#endif
...
{
#ifdef CONFIG_LINUX_KERNEL_3_10
	proc_create_data( "ethernet_dsp_info",0, NULL, &get_ethernet_dsp_info_fops, NULL );
#else
