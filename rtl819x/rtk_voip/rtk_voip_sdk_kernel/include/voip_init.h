...
#if ( defined(CONFIG_LINUX_KERNEL_2_6) || defined(CONFIG_LINUX_KERNEL_3_4)) && !defined(MODULE)
...
#elif defined (CONFIG_LINUX_KERNEL_3_10) && !defined(MODULE)

#define voip_initcall_entry(fn)		__define_initcall(fn,98)
#define voip_initcall_bus(fn)		__define_initcall(fn,98a)
#define voip_initcall_ioc_relay(fn)	__define_initcall(fn,98a)
#define voip_initcall_snd_setup(fn)	__define_initcall(fn,98b)
#define voip_initcall_snd_fts(fn)	__define_initcall(fn,98b)
#define voip_initcall_snd(fn)		__define_initcall(fn,98b)
#define voip_initcall_ioc(fn)		__define_initcall(fn,98c)
#define voip_initcall_dsp(fn)		__define_initcall(fn,98c)
#define voip_initcall_con(fn)		__define_initcall(fn,98d)

#define voip_initcall(fn)			__define_initcall(fn,99)
#define voip_initcall_proc(fn)		__define_initcall(fn,99a)
#define voip_initcall_led(fn)		__define_initcall(fn,99a)
#define voip_initcall_sync(fn)		__define_initcall(fn,99s)
