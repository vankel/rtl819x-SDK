 ...
 * In fact, this enmu is used as packet format.
 * But for static payload type codec, packet format is equal to payload type.
 * For example, AMR-WB packet format are 77 ~ 85, but the RTP payload type of AMR-WB should be
 * dynamic payload (>96).
 * Packet format and payload type can be assigned in TAPI rtk_SetRtpPayloadType() separately.
 */
typedef enum
{
	...
	// 77~95: Unassigned
    rtpPayload_AMR_WB_RATE6P6	= 77,
    rtpPayload_AMR_WB_RATE8P85	= 78,
    rtpPayload_AMR_WB_RATE12P65	= 79,
    rtpPayload_AMR_WB_RATE14P25	= 80,
    rtpPayload_AMR_WB_RATE15P85	= 81,
    rtpPayload_AMR_WB_RATE18P25	= 82,
