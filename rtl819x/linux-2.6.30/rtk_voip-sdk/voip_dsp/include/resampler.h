...
#define PCMRX_RESAMPLER_OFFSET	( IVR_RESAMPLER_OFFSET + 1 * MAX_DSP_RTK_SS_NUM )
#define PCMHDR_RESAMPLER_OFFSET	( PCMRX_RESAMPLER_OFFSET + 1 * MAX_DSP_RTK_CH_NUM )
#define T38HDR_RESAMPLER_OFFSET	( PCMHDR_RESAMPLER_OFFSET + 1 * MAX_DSP_RTK_CH_NUM )
#define PCMRX_LEC_RESAMPLER_OFFSET ( T38HDR_RESAMPLER_OFFSET + 1 * MAX_DSP_RTK_CH_NUM )
#define MAX_NB_CHANNELS		( PCMRX_LEC_RESAMPLER_OFFSET + MAX_DSP_RTK_CH_NUM )	
#else
