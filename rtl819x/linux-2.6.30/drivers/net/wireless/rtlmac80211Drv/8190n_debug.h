 ...
 *
 *  $Id: 8190n_debug.h,v 1.3 2009/09/30 03:29:05 button Exp $
 *
...
#define DEBUG_ERR(fmt, args...)		__DEBUG_ERR(wiphy_name(priv->hw->wiphy), fmt, ## args)
#define DEBUG_INFO(fmt, args...)	__DEBUG_INFO(wiphy_name(priv->hw->wiphy), fmt, ## args)
#define DEBUG_TRACE					__DEBUG_TRACE(wiphy_name(priv->hw->wiphy))
#define DEBUG_WARN(fmt, args...)	__DEBUG_WARN(wiphy_name(priv->hw->wiphy), fmt, ## args)
