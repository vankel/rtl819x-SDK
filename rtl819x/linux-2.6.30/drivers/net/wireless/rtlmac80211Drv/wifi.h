 ...
 *
 *  $Id: wifi.h,v 1.1 2009/09/25 05:15:54 chris Exp $
 *
...
{
	unsigned char	daddr[WLAN_ETHADDR_LEN]		;//__WLAN_ATTRIB_PACK__;
	unsigned char	saddr[WLAN_ETHADDR_LEN]		;//__WLAN_ATTRIB_PACK__;
	unsigned short	type						__WLAN_ATTRIB_PACK__;
} __WLAN_ATTRIB_PACK__;

__PACK struct wlan_llc_t
{
unsigned char	dsap						;//__WLAN_ATTRIB_PACK__;
unsigned char	ssap						;//__WLAN_ATTRIB_PACK__;
unsigned char	ctl							;//__WLAN_ATTRIB_PACK__;
} __WLAN_ATTRIB_PACK__;

/* local snap header type */
__PACK struct wlan_snap_t
{
unsigned char	oui[WLAN_IEEE_OUI_LEN]		;//__WLAN_ATTRIB_PACK__;
unsigned short	type						__WLAN_ATTRIB_PACK__;
} __WLAN_ATTRIB_PACK__;
...
{
unsigned short	ht_cap_info					__WLAN_ATTRIB_PACK__;
unsigned char	ampdu_para					;//__WLAN_ATTRIB_PACK__;
unsigned char	support_mcs[16]				;//__WLAN_ATTRIB_PACK__;
unsigned short	ht_ext_cap					__WLAN_ATTRIB_PACK__;
unsigned int	txbf_cap					__WLAN_ATTRIB_PACK__;
unsigned char	asel_cap					;//__WLAN_ATTRIB_PACK__;
} __WLAN_ATTRIB_PACK__;

__PACK struct ht_info_elmt
{
unsigned char	primary_ch					;//__WLAN_ATTRIB_PACK__;
unsigned char	info0						;//__WLAN_ATTRIB_PACK__;
unsigned short	info1						__WLAN_ATTRIB_PACK__;
unsigned short	info2						__WLAN_ATTRIB_PACK__;
unsigned char	basic_mcs[16]				;//__WLAN_ATTRIB_PACK__;
} __WLAN_ATTRIB_PACK__;

#ifdef WIFI_11N_2040_COEXIST
__PACK struct obss_scan_para_elmt
{
unsigned short	word0					__WLAN_ATTRIB_PACK__;
unsigned short	word1					__WLAN_ATTRIB_PACK__;
unsigned short	word2					__WLAN_ATTRIB_PACK__;
unsigned short	word3					__WLAN_ATTRIB_PACK__;
unsigned short	word4					__WLAN_ATTRIB_PACK__;
unsigned short	word5					__WLAN_ATTRIB_PACK__;
unsigned short	word6					__WLAN_ATTRIB_PACK__;
} __WLAN_ATTRIB_PACK__;
#endif
