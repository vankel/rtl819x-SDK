 ...
 *
 *  $Id: 8190n_headers.h,v 1.4 2009/10/02 09:42:55 chris Exp $
 *
...
EXTERN void free_skb_queue(struct mac80211_shared_priv *priv, struct sk_buff_head *skb_que);
...
EXTERN unsigned int set_fw_reg(struct mac80211_shared_priv *priv, unsigned int cmd, unsigned int val, unsigned int with_val);
...
#ifdef RTL_TX_AMPDU
#ifdef NEW_MAC80211_DRV
EXTERN void ampdu_timeout(struct mac80211_shared_priv *priv, unsigned int current_time);
...
EXTERN int rtl8192SE_SetupOneCmdPacket(struct mac80211_shared_priv *priv, unsigned char *dat_content, unsigned short txLength, unsigned char LastPkt);
...
EXTERN int TxBeacon(struct mac80211_shared_priv *priv, 
...
EXTERN void SwChnl(struct mac80211_shared_priv *priv, unsigned char channel, int offset);
...
EXTERN void init_EDCA_para(struct mac80211_shared_priv *priv, int mode);
EXTERN unsigned int PHY_QueryRFReg(struct mac80211_shared_priv *priv, RF90_RADIO_PATH_E eRFPath,
				unsigned int RegAddr, unsigned int BitMask, unsigned int dbg_avoid);
EXTERN unsigned int PHY_QueryBBReg(struct mac80211_shared_priv *priv, unsigned int RegAddr, unsigned int BitMask);
EXTERN void PHY_SetBBReg(struct mac80211_shared_priv *priv, unsigned int RegAddr, unsigned int BitMask, unsigned int Data);
EXTERN void PHY_SetRFReg(struct mac80211_shared_priv *priv, RF90_RADIO_PATH_E eRFPath, unsigned int RegAddr,
				unsigned int BitMask, unsigned int Data);
EXTERN int phy_BB8192SE_Config_ParaFile(struct mac80211_shared_priv *priv);
EXTERN int phy_BB8190_Config_ParaFile(struct rtl8190_priv *priv);
EXTERN int phy_RF8225_Config_ParaFile(struct mac80211_shared_priv *priv);
EXTERN int phy_RF8256_Config_ParaFile(struct rtl8190_priv *priv);
EXTERN int PHY_ConfigMACWithParaFile(struct mac80211_shared_priv *priv);
EXTERN void SwBWMode(struct mac80211_shared_priv *priv, unsigned int bandwidth, int offset);
#if defined(NEW_MAC80211_DRV)
EXTERN void setup_timer1(struct mac80211_shared_priv *priv, int timeout);
EXTERN void cancel_timer1(struct mac80211_shared_priv *priv);
EXTERN void setup_timer2(struct mac80211_shared_priv *priv, unsigned int timeout);
EXTERN void cancel_timer2(struct mac80211_shared_priv *priv);
#else
...
EXTERN int rtl819x_init_hw_PCI(struct mac80211_shared_priv *priv);
EXTERN int rtl819x_stop_hw(struct mac80211_shared_priv *priv, int reset_bb);
...
EXTERN void rtl8192se_ePhyInit(struct mac80211_shared_priv * priv);
EXTERN void Switch_1SS_Antenna(struct mac80211_shared_priv *priv, unsigned int antPath );
EXTERN void Switch_OFDM_Antenna(struct mac80211_shared_priv *priv, unsigned int antPath );
...
EXTERN int CamAddOneEntry(struct mac80211_shared_priv *priv, unsigned char *pucMacAddr,
				unsigned long ulKeyId, unsigned long ulEncAlg, unsigned long ulUseDK,
				unsigned char *pucKey);
EXTERN int CamDeleteOneEntry(struct mac80211_shared_priv *priv, unsigned char *pucMacAddr,
				unsigned long ulKeyId, unsigned int useDK);
EXTERN void CamResetAllEntry(struct mac80211_shared_priv *priv);
EXTERN void CamDumpAll(struct mac80211_shared_priv *priv);
EXTERN void CAM_read_entry(struct mac80211_shared_priv *priv, unsigned char index, unsigned char *macad,
...
EXTERN void set_mib_default_tbl(struct mac80211_shared_priv *priv);
EXTERN int rtl819x_ioctl(void *, struct iw_point *, int cmd);
/*
...
EXTERN void rtl8190_proc_init (struct mac80211_shared_priv*);
EXTERN void rtl8190_proc_remove (struct mac80211_shared_priv*);
//#endif
