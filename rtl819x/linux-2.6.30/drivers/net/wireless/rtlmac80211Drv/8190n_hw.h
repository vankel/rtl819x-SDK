 ...
 *
 *  $Id: 8190n_hw.h,v 1.4 2009/10/05 09:42:51 george Exp $
 *
...
// switch BE to VI
	...
	int nr_endpoint;
	unsigned char ishighspeed;
	
	pid_t	work_thread_pid;
	_queue	work_queue;
	_sema	work_queue_sema;		
	_sema	terminate_workthread_sema;		

	unsigned char bChangeBBInProgress;
	unsigned char bChangeRFInProgress;
