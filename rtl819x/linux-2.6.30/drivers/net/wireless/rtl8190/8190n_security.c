 ...
 *
 *      $Id: 8190n_security.c,v 1.23 2009/07/15 03:27:33 button Exp $
 */
...
int (*DOT11_Process_WAPI_Info_hook)(struct rtl8190_priv *priv, uint8 *data, int32 len)=NULL;
EXPORT_SYMBOL(DOT11_Process_WAPI_Info_hook);
#endif
		...
		case DOT11_EVENT_WAPI_WRITE_QUEUE:
			{
				...
				#if defined(CONFIG_RTL_WAPI_MODULE_SUPPORT)
				if(DOT11_Process_WAPI_Info_hook != NULL)
					DOT11_Process_WAPI_Info_hook(priv,kernelbuf,data->length);
				#else
