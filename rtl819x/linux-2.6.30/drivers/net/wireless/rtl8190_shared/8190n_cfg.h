 ...
 *
 *		$Id: 8190n_cfg.h,v 1.166 2009/07/13 04:06:39 button Exp $
 */
...
// Support Tx AMSDU
//-------------------------------------------------------------
#if (defined(RTL8190) || defined(RTL8192E)) && !defined(NEW_MAC80211_DRV)
...
#if defined(UNIVERSAL_REPEATER) && !defined(CLIENT_MODE) && !defined(NEW_MAC80211_DRV)
