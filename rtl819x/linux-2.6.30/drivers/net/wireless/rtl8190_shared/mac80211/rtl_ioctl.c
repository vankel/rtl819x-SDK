 ...
 *
 *      $Id: 8190n_ioctl.c,v 1.1 2009/09/25 05:15:54 chris Exp $
 */
...
{
	struct mac80211_shared_priv	*priv = (struct mac80211_shared_priv *)dev->priv;
