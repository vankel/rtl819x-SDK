...
#ifdef CONFIG_RTL_8198C /*only 98C can use this kind of compare, 97D and older cpu would have kernel unaligned access core dump*/
#define isEqualMACAddr(addr1,addr2) ((*(unsigned short*)(addr1) == *(unsigned short*)(addr2)) && (*(unsigned short*)(addr1+2) == *(unsigned short*)(addr2+2)) && (*(unsigned short*)(addr1+4) == *(unsigned short*)(addr2+4)))
#define isEqualIPAddr(addr1,addr2) ((*(unsigned short*)(addr1) == *(unsigned short*)(addr2)) && (*(unsigned short*)(addr1+2) == *(unsigned short*)(addr2+2)))
#else
#define isEqualMACAddr(addr1,addr2) (!memcmp(addr1, addr2, MACADDRLEN))
#define isEqualIPAddr(addr1,addr2)  (!memcmp(addr1, addr2, 4))
#endif
