...
//VHT CAPABILITIES INFO field
	...
	if( priv->pmib->dot11nConfigEntry.dot11nLDPC && (can_enable_rx_ldpc(priv)) )
...
#ifdef AC2G_256QAM
	if(is_ac2g(priv) && (priv->pshare->CurrentChannelBW == HT_CHANNEL_WIDTH_AC_20)) //if bw = 20M, not support MCS9
	{
