...
#define HAL_CODE_BASE   (CODEBASE1|CODEBASE2|CODEBASE3)
...
// TODO: Filen, transfer macro type (TXBD_BEACON_OFFSET_8192E -> TXBD_BEACON_OFFSET_V1)
...
#define HAL_RTL_R8(reg)			sdio_read8(Adapter, reg)
#define HAL_RTL_R16(reg)			sdio_read16(Adapter, reg)
#define HAL_RTL_R32(reg)			sdio_read32(Adapter, reg)
...
#define PlatformEFIORead1Byte(Adapter,reg)		sdio_read8(Adapter, reg)
#define PlatformEFIORead2Byte(Adapter,reg)		sdio_read16(Adapter, reg)
#define PlatformEFIORead4Byte(Adapter,reg)		sdio_read32(Adapter, reg)
