#ifndef REALTEK_POWER_SEQUENCE_8813A
#define REALTEK_POWER_SEQUENCE_8813A
...
/* 
	...
	TRANS_END
*/
#define	RTL8813A_TRANS_CARDEMU_TO_ACT_STEPS	15
#define	RTL8813A_TRANS_ACT_TO_CARDEMU_STEPS	15
#define	RTL8813A_TRANS_CARDEMU_TO_SUS_STEPS	15
#define	RTL8813A_TRANS_SUS_TO_CARDEMU_STEPS	15
#define	RTL8813A_TRANS_CARDEMU_TO_PDN_STEPS	15
#define	RTL8813A_TRANS_PDN_TO_CARDEMU_STEPS	15
#define	RTL8813A_TRANS_ACT_TO_LPS_STEPS	20
#define	RTL8813A_TRANS_LPS_TO_ACT_STEPS	15	
#define	RTL8813A_TRANS_END_STEPS	1


#define RTL8813A_TRANS_CARDEMU_TO_ACT 														\
	/* format */																\
...
#define RTL8813A_TRANS_ACT_TO_CARDEMU													\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\
...
#define RTL8813A_TRANS_CARDEMU_TO_SUS													\
	/* format */								\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\
...
#define RTL8813A_TRANS_SUS_TO_CARDEMU													\
	/* format */								\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\
...
#define RTL8813A_TRANS_CARDEMU_TO_CARDDIS													\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\
	...
	{0x001f, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_USB_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, BIT1, 0}, /* 0x01f[1]=0 , disable RFC_0  control  REG_RF_CTRL_8813A */	\
	{0x0020, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_USB_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, BIT1, 0}, /* 0x020[1]=0 , disable RFC_1  control  REG_RF_CTRL_8813A */	\
	{0x0021, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_USB_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, BIT1, 0}, /* 0x021[1]=0 , disable RFC_2  control  REG_RF_CTRL_8813A */	\
	{0x0076, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_USB_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, BIT1, 0}, /* 0x076[1]=0 , disable RFC_3  control REG_OPT_CTRL_8813A +2 */	\
	{0x0005, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, BIT3, BIT3}, /*0x04[11] = 1 enable WL suspend*/	

#define RTL8813A_TRANS_CARDDIS_TO_CARDEMU													\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/                       \
...
#define RTL8813A_TRANS_CARDEMU_TO_PDN												\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/	\
	{0x0005, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, BIT7, BIT7},/* 0x04[15] = 1*/

#define RTL8813A_TRANS_PDN_TO_CARDEMU												\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/	\
	{0x0005, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, BIT7, 0},/* 0x04[15] = 0*/

#define RTL8813A_TRANS_ACT_TO_LPS														\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\
...
#define RTL8813A_TRANS_LPS_TO_ACT															\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/	\
...
#define RTL8813A_TRANS_END																\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/		\
	{0xFFFF, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,0,PWR_CMD_END, 0, 0}, //


extern WLAN_PWR_CFG rtl8813A_power_on_flow[RTL8813A_TRANS_CARDEMU_TO_ACT_STEPS+RTL8813A_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8813A_radio_off_flow[RTL8813A_TRANS_ACT_TO_CARDEMU_STEPS+RTL8813A_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8813A_card_disable_flow[RTL8813A_TRANS_ACT_TO_CARDEMU_STEPS+RTL8813A_TRANS_CARDEMU_TO_PDN_STEPS+RTL8813A_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8813A_card_enable_flow[RTL8813A_TRANS_ACT_TO_CARDEMU_STEPS+RTL8813A_TRANS_CARDEMU_TO_PDN_STEPS+RTL8813A_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8813A_suspend_flow[RTL8813A_TRANS_ACT_TO_CARDEMU_STEPS+RTL8813A_TRANS_CARDEMU_TO_SUS_STEPS+RTL8813A_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8813A_resume_flow[RTL8813A_TRANS_ACT_TO_CARDEMU_STEPS+RTL8813A_TRANS_CARDEMU_TO_SUS_STEPS+RTL8813A_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8813A_hwpdn_flow[RTL8813A_TRANS_ACT_TO_CARDEMU_STEPS+RTL8813A_TRANS_CARDEMU_TO_PDN_STEPS+RTL8813A_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8813A_enter_lps_flow[RTL8813A_TRANS_ACT_TO_LPS_STEPS+RTL8813A_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8813A_leave_lps_flow[RTL8813A_TRANS_LPS_TO_ACT_STEPS+RTL8813A_TRANS_END_STEPS];
