...
int32 apollomp_raw_flowctrl_publicJumboUsedPageCnt_get(uint32 *pCurrent, uint32 *pMaximum)
{
    ...
    if ((ret = reg_field_read(APOLLOMP_FC_PUB_JUMBO_USED_PAGE_CNTr, APOLLOMP_PUB_JUMBO_MAX_USED_PAGE_CNTf, pCurrent)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_FLOWCTRL|MOD_DAL), "");
        return ret;
    }
 ...
 *      None
 */
int32 apollomp_raw_flowctrl_ponUsedPageCtrl_set(uint32 queue, uint32 clear)
{
    int32   ret;
    ...
    if ((ret = reg_field_write(APOLLOMP_FC_PON_Q_USED_PAGE_CTRLr, APOLLOMP_QIDf, &queue)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_FLOWCTRL), "");
        return ret;
    }

    if ((ret = reg_field_write(APOLLOMP_FC_PON_Q_USED_PAGE_CTRLr, APOLLOMP_QIDf, &clear)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_FLOWCTRL), "");
        return ret;
    }
...
static int32 _patch_35m_gpon(void)
{
    ...
    if ((ret = apollomp_raw_flowctrl_ponGlobalHighThreshold_set(4495, 4062)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_FLOWCTRL | MOD_DAL), "");
        return ret;
    }
    ...
    if ((ret = apollomp_raw_flowctrl_ponGlobalLowThreshold_set(2764, 2487)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_FLOWCTRL | MOD_DAL), "");
        return ret;
    }
    ...
    if ((ret = apollomp_raw_flowctrl_ponPortHighThreshold_set(2048, 1952)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_FLOWCTRL | MOD_DAL), "");
        return ret;
    }
    ...
    if ((ret = apollomp_raw_flowctrl_ponPortLowThreshold_set(375, 327)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_FLOWCTRL | MOD_DAL), "");
        return ret;
    }

    /* ingress PON flowctrl egress-drop, threshold idx 0 threshold 70 */
    if ((ret = apollomp_raw_flowctrl_ponQueueEegressDropThreshold_set(0, 70)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_FLOWCTRL | MOD_DAL), "");
        return ret;
    }
...
static int32 _patch_20m(void)
{
    ...
    if ((ret = apollomp_raw_flowctrl_globalFconHighThreshold_set(2122, 2042)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_FLOWCTRL | MOD_DAL), "");
        return ret;
    }
    ...
    if ((ret = apollomp_raw_flowctrl_globalFcoffHighThreshold_set(2122, 2042)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_FLOWCTRL | MOD_DAL), "");
        return ret;
    }
    ...
    if ((ret = apollomp_raw_flowctrl_globalFconLowThreshold_set(1802, 1622)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_FLOWCTRL | MOD_DAL), "");
        return ret;
    }
    ...
    if ((ret = apollomp_raw_flowctrl_globalFcoffLowThreshold_set(1802, 1622)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_FLOWCTRL | MOD_DAL), "");
        return ret;
    }
    ...
    HAL_SCAN_ALL_PORT(port)
    {
        if ((ret = apollomp_raw_flowctrl_portEegressDropThreshold_set(port, 4000)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_FLOWCTRL | MOD_DAL), "");
            return ret;
        }
    ...
    if ((ret = apollomp_raw_flowctrl_ponGlobalHighThreshold_set(1776, 1696)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_FLOWCTRL | MOD_DAL), "");
        return ret;
    }
    ...
    if ((ret = apollomp_raw_flowctrl_ponGlobalLowThreshold_set(1456, 1310)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_FLOWCTRL | MOD_DAL), "");
        return ret;
    }
    ...
    for(queue = 0; queue < HAL_CLASSIFY_SID_NUM(); queue++)
    {
        if ((ret = apollomp_raw_flowctrl_ponQueueEegressGapThreshold_set(160)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_FLOWCTRL | MOD_DAL), "");
            return ret;
        }
