...
dal_apollomp_acl_igrRuleAction_set(rtk_acl_ingress_entry_t *pAclRule)
{
	...
	if(pAclRule->act.enableAct[ACL_IGR_INTR_ACT])
	{
		...
		if ((ret = table_field_set(APOLLOMP_ACL_ACTION_TABLEt, APOLLOMP_ACL_ACTION_TABLE_CFACTtf, &val, actionData)) != RT_ERR_OK)
	    {
	        RT_ERR(ret, (MOD_ACL|MOD_DAL), "");
	        return ret;
	    }
    ...
    if(pAclRule->act.enableAct[ACL_IGR_PRI_ACT])
    {
		...
		if ((ret = table_field_set(APOLLOMP_ACL_ACTION_TABLEt, APOLLOMP_ACL_ACTION_TABLE_PRIACTtf, &val, actionData)) != RT_ERR_OK)
	    {
	        RT_ERR(ret, (MOD_ACL|MOD_DAL), "");
	        return ret;
	    }
    ...
    if(pAclRule->act.enableAct[ACL_IGR_FORWARD_ACT])
    {
		...
		if ((ret = table_field_set(APOLLOMP_ACL_ACTION_TABLEt, APOLLOMP_ACL_ACTION_TABLE_FWDACTtf, &val, actionData)) != RT_ERR_OK)
	    {
	        RT_ERR(ret, (MOD_ACL|MOD_DAL), "");
	        return ret;
	    }
    ...
    if(pAclRule->act.enableAct[ACL_IGR_LOG_ACT])
    {
		...
		if ((ret = table_field_set(APOLLOMP_ACL_ACTION_TABLEt, APOLLOMP_ACL_ACTION_TABLE_POLICACTtf, &val, actionData)) != RT_ERR_OK)
	    {
	        RT_ERR(ret, (MOD_ACL|MOD_DAL), "");
	        return ret;
	    }
    ...
    if(pAclRule->act.enableAct[ACL_IGR_SVLAN_ACT])
    {
		...
		if ((ret = table_field_set(APOLLOMP_ACL_ACTION_TABLEt, APOLLOMP_ACL_ACTION_TABLE_SACTtf, &val, actionData)) != RT_ERR_OK)
	    {
	        RT_ERR(ret, (MOD_ACL|MOD_DAL), "");
	        return ret;
	    }
    ...
    if(pAclRule->act.enableAct[ACL_IGR_CVLAN_ACT])
    {
		...
		if ((ret = table_field_set(APOLLOMP_ACL_ACTION_TABLEt, APOLLOMP_ACL_ACTION_TABLE_CACTtf, &val, actionData)) != RT_ERR_OK)
	    {
	        RT_ERR(ret, (MOD_ACL|MOD_DAL), "");
	        return ret;
	    }
...
dal_apollomp_acl_igrRuleAction_get(rtk_acl_ingress_entry_t *pAclRule)
{
    ...
    /*Interrupt and extend action control*/
	if ((ret = table_field_get(APOLLOMP_ACL_ACTION_TABLEt, APOLLOMP_ACL_ACTION_TABLE_CFACTtf, &val, actionData)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_ACL|MOD_DAL), "");
        return ret;
    }
    ...
    /*Priority action control*/
	if ((ret = table_field_get(APOLLOMP_ACL_ACTION_TABLEt, APOLLOMP_ACL_ACTION_TABLE_PRIACTtf, &val, actionData)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_ACL|MOD_DAL), "");
        return ret;
    }
    ...
    /*Forward action control*/
	if ((ret = table_field_get(APOLLOMP_ACL_ACTION_TABLEt, APOLLOMP_ACL_ACTION_TABLE_FWDACTtf, &val, actionData)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_ACL|MOD_DAL), "");
        return ret;
    }
    ...
    /*Logging or Policing action control*/
	if ((ret = table_field_get(APOLLOMP_ACL_ACTION_TABLEt, APOLLOMP_ACL_ACTION_TABLE_POLICACTtf, &val, actionData)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_ACL|MOD_DAL), "");
        return ret;
    }
    ...
    /*svlan action control*/
	if ((ret = table_field_get(APOLLOMP_ACL_ACTION_TABLEt, APOLLOMP_ACL_ACTION_TABLE_SACTtf, &val, actionData)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_ACL|MOD_DAL), "");
        return ret;
    }
    ...
    /*cvlan action control*/
	if ((ret = table_field_get(APOLLOMP_ACL_ACTION_TABLEt, APOLLOMP_ACL_ACTION_TABLE_CACTtf, &val, actionData)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_ACL|MOD_DAL), "");
        return ret;
    }
...
dal_apollomp_acl_igrRuleEntry_delAll(void)
{
    ...
    if((ret = apollomp_l2_table_clear(APOLLOMP_ACL_DATAt,0,index)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_ACL|MOD_DAL), "");
		return ret;
    }

    if((ret = apollomp_l2_table_clear(APOLLOMP_ACL_MASKt,0,index)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_ACL|MOD_DAL), "");
		return ret;
    }
    ...
    if((ret = apollomp_l2_table_clear(APOLLOMP_ACL_ACTION_TABLEt,0,index)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_ACL|MOD_DAL), "");
		return ret;
    }
