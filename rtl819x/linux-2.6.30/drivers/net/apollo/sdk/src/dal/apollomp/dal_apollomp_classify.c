                                ...
                                apollomp_raw_cf_dsAct_t     *pDsAction)
{
    ...
    {   /* us action */
        ...
        pUsAction->sid_act      = pClassifyCfg->act.usAct.sidQidAct;
    ...
    else /* ds action */
    {
        ...
        pDsAction->uni_act      = pClassifyCfg->act.dsAct.uniAct;
                                ...
                                rtk_classify_cfg_t          *pClassifyCfg)
{
    ...
    {   /* us action */
        ...
        pClassifyCfg->act.usAct.sidQidAct   = pUsAction->sid_act;
    ...
    else /* ds action */
    {
        ...
        pClassifyCfg->act.dsAct.uniAct      = pDsAction->uni_act;
