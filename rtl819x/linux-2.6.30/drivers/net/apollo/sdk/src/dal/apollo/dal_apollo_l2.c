...
dal_apollo_l2_init(void)
{
    ...
    HAL_SCAN_ALL_PORT(port)
    {
        ...
        if((ret = dal_apollo_l2_ucastAddr_flush(&flush_cfg)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_L2 | MOD_DAL), "");
            l2_init = INIT_NOT_COMPLETED;
            return ret;
    ...
    if((ret = dal_apollo_l2_srcPortEgrFilterMask_set(&empty_portmask)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L2 | MOD_DAL), "");
        l2_init = INIT_NOT_COMPLETED;
        return ret;
    ...
    if((ret = dal_apollo_l2_extPortEgrFilterMask_set(&empty_portmask)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L2 | MOD_DAL), "");
        l2_init = INIT_NOT_COMPLETED;
        return ret;
 ...
 */
int32
dal_apollo_l2_learningCnt_get(uint32 *pMac_cnt)
{
    int32 ret;
    ...
    /* get value from CHIP*/
    if((ret = reg_field_read(LUT_LRN_LIMITNOr, NUMf, pMac_cnt)) != RT_ERR_OK)
    {
 ...
 */
int32
dal_apollo_l2_limitLearningCnt_get(uint32 *pMac_cnt)
{
    int32 ret;
    ...
    /* get value from CHIP*/
    if((ret = reg_field_read(LUT_SYS_LRN_LIMITNOr, SYS_LRN_LIMITNOf, pMac_cnt)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
        return ret;
    }
 ...
 */
int32
dal_apollo_l2_limitLearningCnt_set(uint32 mac_cnt)
{
    int32 ret;
    ...
    if((ret = reg_field_write(LUT_SYS_LRN_LIMITNOr, SYS_LRN_LIMITNOf, &mac_cnt)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
        return ret;
    }
 ...
 */
int32
dal_apollo_l2_limitLearningCntAction_get(rtk_l2_limitLearnCntAction_t *pAction)
{
    int32   ret;
    uint32  act;
 ...
 */
int32
dal_apollo_l2_limitLearningCntAction_set(rtk_l2_limitLearnCntAction_t action)
{
    int32   ret;
    uint32  act;
 ...
 */
int32
dal_apollo_l2_portLimitLearningCntAction_get(rtk_port_t port, rtk_l2_limitLearnCntAction_t *pAction)
{
    int32   ret;
    rtk_action_t act;
 ...
 */
int32
dal_apollo_l2_portLimitLearningCntAction_set(rtk_port_t port, rtk_l2_limitLearnCntAction_t action)
{
    ...
    rtk_l2_ucastAddr_t  *pL2Data)
{
    ...
    if ((ret = _dal_apollo_rawtoL2uc(pL2Data, &lut_entry)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L2 | MOD_DAL), "");
        return ret;
    }
    ...
    rtk_l2_mcastAddr_t  *pL2Data)
{
    ...
    if ((ret = _dal_apollo_rawtoL2mc(pL2Data, &lut_entry)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L2 | MOD_DAL), "");
        return ret;
    }
    ...
    rtk_l2_ipMcastAddr_t    *pL2Data)
{
    ...
    if ((ret = _dal_apollo_rawtoIpmc(pL2Data, &lut_entry)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L2 | MOD_DAL), "");
        return ret;
    }
 ...
 */
int32
dal_apollo_l2_ipmcGroupLookupMissHash_get(rtk_l2_ipmcHashOp_t *pMode)
{
    int32   ret;
 ...
 */
int32
dal_apollo_l2_ipmcGroupLookupMissHash_set(rtk_l2_ipmcHashOp_t mode)
{
    int32   ret;
    apollo_raw_l2_ipMcLookupOp_t raw_mode;
...
dal_apollo_l2_srcPortEgrFilterMask_get(rtk_portmask_t *pFilter_portmask)
{
    ...
    HAL_SCAN_ALL_PORT(port)
    {
        if ((ret = reg_array_field_read(L2_SRC_PORT_PERMITr, (uint32)port, REG_ARRAY_INDEX_NONE, ENf, &enable)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_L2|MOD_DAL), "");
            return ret;
        }
...
dal_apollo_l2_srcPortEgrFilterMask_set(rtk_portmask_t *pFilter_portmask)
{
    ...
    HAL_SCAN_ALL_PORT(port)
    {
        ...
        if ((ret = reg_array_field_write(L2_SRC_PORT_PERMITr, (uint32)port, REG_ARRAY_INDEX_NONE, ENf, &enable)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_L2|MOD_DAL), "");
            return ret;
        }
...
dal_apollo_l2_extPortEgrFilterMask_get(rtk_portmask_t *pExt_portmask)
{
    ...
    {
        if ((ret = reg_array_field_read(L2_SRC_EXT_PERMITr, REG_ARRAY_INDEX_NONE, (uint32)port, ENf, &enable)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_L2|MOD_DAL), "");
            return ret;
        }
...
dal_apollo_l2_extPortEgrFilterMask_set(rtk_portmask_t *pExt_portmask)
{
    ...
    HAL_SCAN_ALL_EXT_PORT_EX_CPU(port)
    {
        ...
        if ((ret = reg_array_field_write(L2_SRC_EXT_PERMITr, REG_ARRAY_INDEX_NONE, (uint32)port, ENf, &enable)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_L2|MOD_DAL), "");
            return ret;
        }
