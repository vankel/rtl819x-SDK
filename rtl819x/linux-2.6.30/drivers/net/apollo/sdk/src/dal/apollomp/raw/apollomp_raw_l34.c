...
int32 apollomp_raw_l34_hsaData_set(apollomp_raw_l34_hsa_t *hsaData)
{
    ...
    for(index=0 ; index<(sizeof(apollomp_l34_hsa_entry_t)/4) ; index++)
    {
        if ((ret = reg_array_write(APOLLOMP_HSA_DESCr,REG_ARRAY_INDEX_NONE,index,tmp_val_ptr)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_L34|MOD_DAL), "");
            return ret;
        }
...
int32 apollomp_raw_l34_hsaData_get(apollomp_raw_l34_hsa_t *hsaData)
{
    ...
    for(index=0 ; index<(sizeof(apollomp_l34_hsa_entry_t)/4) ; index++)
    {
        if ((ret = reg_array_read(APOLLOMP_HSA_DESCr,REG_ARRAY_INDEX_NONE,index,tmp_val_ptr)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_L34|MOD_DAL), "");
            return ret;
        }
...
int32 apollomp_raw_l34_hsbData_set(apollomp_raw_l34_hsb_t *hsbData)
{
    ...
    for(index=0 ; index<(sizeof(apollomp_l34_hsb_entry_t)/4) ; index++)
    {
        if ((ret = reg_array_write(APOLLOMP_HSB_DESCr,REG_ARRAY_INDEX_NONE,index,tmp_val_ptr)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_L34|MOD_DAL), "");
            return ret;
        }
...
int32 apollomp_raw_l34_hsbData_get(apollomp_raw_l34_hsb_t *hsbData)
{
    ...
    for(index=0 ; index<(sizeof(apollomp_l34_hsb_entry_t)/4) ; index++)
    {
        if ((ret = reg_array_read(APOLLOMP_HSB_DESCr,REG_ARRAY_INDEX_NONE,index,tmp_val_ptr)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_L34|MOD_DAL), "");
            return ret;
        }
 ...
 *      None
 */
int32 apollomp_raw_l34_pppoeTrf_get(uint8 *pppoeTrf)
{
	int32 ret;
    uint32 tmp_val;
...
apollomp_raw_l34_ipmcTransEntry_set(apollomp_raw_l34_ipmcTransEntry_t *entry)
{
    ...
    if ((ret = reg_array_field_write(APOLLOMP_L34_IPMC_TRAN_TBLr, index, REG_ARRAY_INDEX_NONE, APOLLOMP_NETIF_IDXf, &tmpVal)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L34|MOD_DAL), "");
        return ret;
    }
    ...
    if ((ret = reg_array_field_write(APOLLOMP_L34_IPMC_TRAN_TBLr, index, REG_ARRAY_INDEX_NONE, APOLLOMP_EN_SIP_TRANSf, &tmpVal)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L34|MOD_DAL), "");
        return ret;
    }
    ...
    if ((ret = reg_array_field_write(APOLLOMP_L34_IPMC_TRAN_TBLr, index, REG_ARRAY_INDEX_NONE, APOLLOMP_EXT_IP_IDXf, &tmpVal)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L34|MOD_DAL), "");
        return ret;
    }            

    tmpVal = entry->isPppoeIf;
    if ((ret = reg_array_field_write(APOLLOMP_L34_IPMC_TRAN_TBLr, index, REG_ARRAY_INDEX_NONE, APOLLOMP_IS_PPPOE_IFf, &tmpVal)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L34|MOD_DAL), "");
        return ret;
    }
    ...
    if ((ret = reg_array_field_write(APOLLOMP_L34_IPMC_TRAN_TBLr, index, REG_ARRAY_INDEX_NONE, APOLLOMP_PPPOE_IDXf, &tmpVal)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L34|MOD_DAL), "");
        return ret;
    }  
...
apollomp_raw_l34_ipmcTransEntry_get(apollomp_raw_l34_ipmcTransEntry_t *entry)
{
    ...
    if ((ret = reg_array_field_read(APOLLOMP_L34_IPMC_TRAN_TBLr, index, REG_ARRAY_INDEX_NONE, APOLLOMP_NETIF_IDXf, &tmpVal)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L34|MOD_DAL), "");
        return ret;
    }
    ...
    if ((ret = reg_array_field_read(APOLLOMP_L34_IPMC_TRAN_TBLr, index, REG_ARRAY_INDEX_NONE, APOLLOMP_EN_SIP_TRANSf, &tmpVal)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L34|MOD_DAL), "");
        return ret;
    }
    ...
    if ((ret = reg_array_field_read(APOLLOMP_L34_IPMC_TRAN_TBLr, index, REG_ARRAY_INDEX_NONE, APOLLOMP_EXT_IP_IDXf, &tmpVal)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L34|MOD_DAL), "");
        return ret;
    }            
    ...
    if ((ret = reg_array_field_read(APOLLOMP_L34_IPMC_TRAN_TBLr, index, REG_ARRAY_INDEX_NONE, APOLLOMP_IS_PPPOE_IFf, &tmpVal)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L34|MOD_DAL), "");
        return ret;
    }
    entry->isPppoeIf = tmpVal;

    if ((ret = reg_array_field_read(APOLLOMP_L34_IPMC_TRAN_TBLr, index, REG_ARRAY_INDEX_NONE, APOLLOMP_PPPOE_IDXf, &tmpVal)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L34|MOD_DAL), "");
        return ret;
    }  
...
int32 apollomp_raw_l34_bdTrf_get(uint8 *bdTrf)
{
	int32 ret;
    uint32 tmpVal[4];    

    RT_PARAM_CHK((bdTrf==NULL), RT_ERR_NULL_POINTER);
    
    if ((ret = reg_field_read(APOLLOMP_BD_TRFr, APOLLOMP_BD_TRF_BMPf, (uint32 *)tmpVal)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L34|MOD_DAL), "");
        return ret;
    }
    memcpy(bdTrf,tmpVal,sizeof(tmpVal));
