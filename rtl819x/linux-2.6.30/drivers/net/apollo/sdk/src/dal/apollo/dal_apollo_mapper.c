...
dal_mapper_t dal_apollo_mapper =
{
    ...
    .trap_rmaVlanCheckEnable_get = dal_apollo_trap_rmaVlanCheckEnable_get,
    .trap_rmaVlanCheckEnable_set = dal_apollo_trap_rmaVlanCheckEnable_set,
    .trap_rmaPortIsolationEnable_get = dal_apollo_trap_rmaPortIsolationEnable_get,
    .trap_rmaPortIsolationEnable_set = dal_apollo_trap_rmaPortIsolationEnable_set,
    .trap_rmaStormControlEnable_get = dal_apollo_trap_rmaStormControlEnable_get,
    .trap_rmaStormControlEnable_set = dal_apollo_trap_rmaStormControlEnable_set,
    .trap_rmaKeepCtagEnable_get = dal_apollo_trap_rmaKeepCtagEnable_get,
    .trap_rmaKeepCtagEnable_set = dal_apollo_trap_rmaKeepCtagEnable_set,
    ...
    .port_isolationEntry_get = (int32 (*)(rtk_port_isoConfig_t, rtk_port_t, rtk_portmask_t *, uint32 *, rtk_portmask_t *))dal_common_unavail,
    .port_isolationEntry_set = (int32 (*)(rtk_port_isoConfig_t, rtk_port_t, rtk_portmask_t *, uint32, rtk_portmask_t *))dal_common_unavail,
    .port_isolationEntryExt_get = (int32 (*)(rtk_port_isoConfig_t, rtk_port_t, rtk_portmask_t *, uint32 *, rtk_portmask_t *))dal_common_unavail,
    .port_isolationEntryExt_set = (int32 (*)(rtk_port_isoConfig_t, rtk_port_t, rtk_portmask_t *, uint32, rtk_portmask_t *))dal_common_unavail,
    ...
    .l34_naptOutboundHashidx_get   = dal_apollo_l34_naptOutboundHashidx_get,
    ...
    .acl_ruleEntry_get = dal_apollo_acl_igrRuleEntry_get,
    .acl_igrField_add = dal_apollo_acl_igrRuleField_add,
    ...
    /* RLDP and RLPP */
    .rldp_init = (int32 (*)(void))dal_common_unavail,
