 ...
 *
 * $Revision: 10951 $
 * $Date: 2010-07-15 10:32:24 +0800 (?Ÿæ??? 15 ä¸ƒæ? 2010) $
 *
...
dal_apollo_qos_init(void)
{
    ...
    if ((ret = apollo_raw_qos_wfqBurstSize_set(0x1200)) != RT_ERR_OK)
    {
    ...
    if ((ret = dal_apollo_qos_priSelGroup_set(0, &priSelWeight)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_QOS|MOD_DAL), "");
        qos_init = INIT_NOT_COMPLETED;
        return ret;
    ...
    { 
        if ((ret = dal_apollo_qos_1pPriRemapGroup_set(0,priority,dot1pPriRemap[priority],0)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_QOS|MOD_DAL), "");
            qos_init = INIT_NOT_COMPLETED;
            return ret;
    ...
    { 
        if ((ret = dal_apollo_qos_dscpPriRemapGroup_set(0,dscpVal,0,0)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_QOS|MOD_DAL), "");
            qos_init = INIT_NOT_COMPLETED;
            return ret;
    ...
    */
    if ((ret = dal_apollo_qos_priMap_set(0, &queueMap0)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_QOS|MOD_DAL), "");
        qos_init = INIT_NOT_COMPLETED;
        return ret;
    }
    if ((ret = dal_apollo_qos_priMap_set(1, &queueMap1)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_QOS|MOD_DAL), "");
        qos_init = INIT_NOT_COMPLETED;
        return ret;
    ...
    { 
        ...
        if ((ret = dal_apollo_qos_portPri_set(port, RTK_DEFAULT_QOS_PORT_PRIORITY)) != RT_ERR_OK)
        {
        ...
        if ((ret = dal_apollo_qos_dscpRemarkEnable_set(port, DISABLED)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_QOS|MOD_DAL), "");
            qos_init = INIT_NOT_COMPLETED;
            return ret;
        ...
        if ((ret = dal_apollo_qos_1pRemarkEnable_set(port, DISABLED)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_QOS|MOD_DAL), "");
            qos_init = INIT_NOT_COMPLETED;
            return ret;
        ...
        {/*skip pon port*/
            if ((ret = dal_apollo_qos_schedulingQueue_set(port, &queueWeight)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_QOS|MOD_DAL), "");
                qos_init = INIT_NOT_COMPLETED;
                return ret;
        ...
        */
        ...
        {
            if ((ret = dal_apollo_qos_portPriMap_set(port, 0)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_QOS|MOD_DAL), "");
                qos_init = INIT_NOT_COMPLETED;
                return ret;
        ...
        {
            if ((ret = dal_apollo_qos_portPriMap_set(port, 1)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_QOS|MOD_DAL), "");
                qos_init = INIT_NOT_COMPLETED;
                return ret;
    ...
    qos_init = INIT_COMPLETED;
    return RT_ERR_OK;
} /* end of dal_apollo_qos_init */


/* Function Name:
 *      dal_apollo_qos_priSelGroup_get
 * Description:
 ...
 */
int32
dal_apollo_qos_priSelGroup_get(uint32 grpIdx, rtk_qos_priSelWeight_t *pWeightOfPriSel)
{
    int32   ret;
    uint32 weight;
    ...
    /* parameter check */
    RT_PARAM_CHK((0 != grpIdx), RT_ERR_INPUT);
    RT_PARAM_CHK((NULL == pWeightOfPriSel), RT_ERR_NULL_POINTER);

    if ((ret = reg_field_read(PRI_SEL_TBL_CTRLr, SVLAN_WEIGHTf, &weight)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_QOS|MOD_DAL), "");
        return ret;
    }
    ...
    if ((ret = reg_field_read(PRI_SEL_TBL_CTRLr, SA_WEIGHTf, &weight)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_QOS|MOD_DAL), "");
        return ret;
    }
    ...
    if ((ret = reg_field_read(PRI_SEL_TBL_CTRLr, LUTFWD_WEIGHTf, &weight)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_QOS|MOD_DAL), "");
        return ret;
    }
    ...
    if ((ret = reg_field_read(PRI_SEL_TBL_CTRLr, CVLAN_WEIGHTf, &weight)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_QOS|MOD_DAL), "");
        return ret;
    }
    ...
    if ((ret = reg_field_read(PRI_SEL_TBL_CTRLr, ACL_WEIGHTf, &weight)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_QOS|MOD_DAL), "");
        return ret;
    }
    ...
    if ((ret = reg_field_read(PRI_SEL_TBL_CTRLr, DSCP_WEIGHTf, &weight)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_QOS|MOD_DAL), "");
        return ret;
    }
    ...
    if ((ret = reg_field_read(PRI_SEL_TBL_CTRLr, DOT1Q_WEIGHTf, &weight)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_QOS|MOD_DAL), "");
        return ret;
    }
    ...
    if ((ret = reg_field_read(PRI_SEL_TBL_CTRLr, PORT_WEIGHTf, &weight)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_QOS|MOD_DAL), "");
        return ret;
    }
    ...
    if ((ret = reg_field_read(PRI_SEL_TBL_CTRL2r, L4_WEIGHTf, &weight)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_QOS|MOD_DAL), "");
        return ret;
    }
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_qos_priSelGroup_get */

/* Function Name:
 *      dal_apollo_qos_priSelGroup_set
 * Description:
 ...
 */
int32
dal_apollo_qos_priSelGroup_set(uint32 grpIdx, rtk_qos_priSelWeight_t *pWeightOfPriSel)
{
    int32   ret;
    uint32 weight;
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_qos_priSelGroup_set */


/* Function Name:
 *      dal_apollo_qos_portPri_get
 * Description:
 ...
 */
int32
dal_apollo_qos_portPri_get(rtk_port_t port, rtk_pri_t *pIntPri)
{
    int32   ret;
    uint32  intPri;
    RT_DBG(LOG_DEBUG, (MOD_DAL|MOD_QOS),"%s",__FUNCTION__);
    ...
    if ((ret = apollo_raw_qos_portBasePri_get(port, &intPri)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_QOS), "");
        return ret;
    }    
    ...
    *pIntPri = intPri;
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_qos_portPri_get */


/* Function Name:
 *      dal_apollo_qos_portPri_set
 * Description:
 *      Get internal priority of one port.
 * Input:
 *      port     - port id
 ...
 */
int32
dal_apollo_qos_portPri_set(rtk_port_t port, rtk_pri_t intPri)
{
    int32   ret;
    ...
    if ((ret = apollo_raw_qos_portBasePri_set(port, intPri)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_QOS), "");
        return ret;
    }  
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_qos_portPri_set */


/* Function Name:
 *      dal_apollo_qos_dscpPriRemapGroup_get
 * Description:
    ...
    uint32      *pDp)
{
    ...
    if ((ret = apollo_raw_qos_dscpPriRemap_get(dscp, &intPri)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_QOS), "");
        return ret;
    }
    ...
    *pIntPri = intPri;
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_qos_dscpPriRemapGroup_get */

/* Function Name:
 *      dal_apollo_qos_dscpPriRemapGroup_set
 * Description:
    ...
    uint32      dp)
{
    ...
    if ((ret = apollo_raw_qos_dscpPriRemap_set(dscp, intPri)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_QOS), "");
        return ret;
    }
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_qos_dscpPriRemapGroup_set */


/* Function Name:
 *      dal_apollo_qos_1pPriRemapGroup_get
 * Description:
    ...
    uint32      *pDp)
{
    ...
    if ((ret = apollo_raw_qos_1QPriRemap_get(dot1pPri, &intPri)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_QOS), "");
        return ret;
    }
    ...
    *pIntPri = intPri;
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_qos_1pPriRemapGroup_get */

/* Function Name:
 *      dal_apollo_qos_1pPriRemapGroup_set
 * Description:
    ...
    uint32      dp)
{
    ...
    if ((ret = apollo_raw_qos_1QPriRemap_set(dot1pPri, intPri)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_QOS), "");
        return ret;
    }
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_qos_1pPriRemapGroup_set */


/* Function Name:
 *      dal_apollo_qos_priMap_set
 * Description:
 ...
 */
int32
dal_apollo_qos_priMap_set(uint32 group, rtk_qos_pri2queue_t *pPri2qid)
{
    int32   ret;
    int32   priority;
    ...
    {
        if ((ret = apollo_raw_qos_priToQidMappingTable_set(group, priority, pPri2qid->pri2queue[priority])) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_DAL|MOD_QOS), "");
            return ret;
        }   
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_qos_priMap_set */
 ...
 */
int32
dal_apollo_qos_priMap_get(uint32 group, rtk_qos_pri2queue_t *pPri2qid)
{
    int32   ret;
    int32   priority;
    uint32  qid;
    ...
    for(priority = 0;priority <= HAL_INTERNAL_PRIORITY_MAX();priority++)
    {
        if ((ret = apollo_raw_qos_priToQidMappingTable_get(group, priority, &qid)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_DAL|MOD_QOS), "");
            return ret;
        }
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_qos_priMap_get */


/* Function Name:
 *      dal_apollo_qos_portPriMap_get
 * Description:
 ...
 */
int32 
dal_apollo_qos_portPriMap_get(rtk_port_t port, uint32 *pGroup)
{
    int32   ret;
    ...
    if ((ret = apollo_raw_qos_portQidMapIdx_get(port, pGroup)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_QOS), "");
        return ret;
    }
...
} /* end of dal_apollo_qos_portPriMap_get */

/* Function Name:
 *      dal_apollo_qos_portPriMap_set
 * Description:
 ...
 */
int32
dal_apollo_qos_portPriMap_set(rtk_port_t port, uint32 group)
{
    int32   ret;
    ...
    if ((ret = apollo_raw_qos_portQidMapIdx_set(port, group)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_QOS), "");
        return ret;
    }
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_qos_portPriMap_set */

/* Module Name    : QoS           */
/* Sub-module Name: Egress remark */
/* Function Name:
 *      dal_apollo_qos_1pRemarkEnable_get
 * Description:
 ...
 */
int32
dal_apollo_qos_1pRemarkEnable_get(rtk_port_t port, rtk_enable_t *pEnable)
{
    int32   ret;
    ...
    if ((ret = apollo_raw_qos_1qRemarkAbility_get(port, pEnable)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_QOS), "");
        return ret;
    }
    return RT_ERR_OK;
} /* end of dal_apollo_qos_1pRemarkEnable_get */

/* Function Name:
 *      dal_apollo_qos_1pRemarkEnable_set
 * Description:
 ...
 */
int32
dal_apollo_qos_1pRemarkEnable_set(rtk_port_t port, rtk_enable_t enable)
{
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_qos_1pRemarkEnable_set */




/* Function Name:
 *      dal_apollo_qos_1pRemarkGroup_get
 * Description:
    ...
    rtk_pri_t   *pDot1pPri)
{
    ...
    if ((ret = apollo_raw_qos_1qRemarkPri_get(intPri, &do1pPri)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_QOS), "");
        return ret;
    }
    *pDot1pPri = (rtk_pri_t)do1pPri;
    return RT_ERR_OK;
} /* end of dal_apollo_qos_1pRemarkGroup_get */

/* Function Name:
 *      dal_apollo_qos_1pRemarkGroup_set
 * Description:
    ...
    rtk_pri_t dot1pPri)
{
    ...
    if ((ret = apollo_raw_qos_1qRemarkPri_set(intPri, dot1pPri)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_QOS), "");
        return ret;
    } 
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_qos_1pRemarkGroup_set */

/* Function Name:
 *      dal_apollo_qos_dscpRemarkEnable_get
 * Description:
 ...
 */
int32
dal_apollo_qos_dscpRemarkEnable_get(rtk_port_t port, rtk_enable_t *pEnable)
{
    ...
    if ((ret = apollo_raw_qos_dscpRemarkAbility_get(port, pEnable)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_QOS), "");
        return ret;
    } 
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_qos_dscpRemarkEnable_get */

/* Function Name:
 *      dal_apollo_qos_dscpRemarkEnable_set
 * Description:
 ...
 */
int32
dal_apollo_qos_dscpRemarkEnable_set(rtk_port_t port, rtk_enable_t enable)
{
    int32   ret;
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_qos_dscpRemarkEnable_set */


/* Function Name:
 *      dal_apollo_qos_dscpRemarkGroup_get
 * Description:
    ...
    uint32      *pDscp)
{
    ...
    if ((ret = apollo_raw_qos_interPriRemarkDscp_get(intPri, &dscpVal)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_QOS), "");
        return ret;
    }   
    *pDscp = dscpVal;
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_qos_dscpRemarkGroup_get */

/* Function Name:
 *      dal_apollo_qos_dscpRemarkGroup_set
 * Description:
    ...
    uint32      dscp)
{
    ...
    if ((ret = apollo_raw_qos_interPriRemarkDscp_set(intPri, dscp)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_QOS), "");
        return ret;
    }   
    return RT_ERR_OK;
} /* end of dal_apollo_qos_dscpRemarkGroup_set */


/* Function Name:
 *      dal_apollo_qos_portDscpRemarkSrcSel_get
 * Description:
 ...
 */
int32
dal_apollo_qos_portDscpRemarkSrcSel_get(rtk_port_t port, rtk_qos_dscpRmkSrc_t *pType)
{
    int32   ret;
    apollo_raw_dscp_source_t dscpSource;
    ...
    if ((ret = apollo_raw_qos_dscpRemarkSource_get(port, &dscpSource)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_QOS), "");
        return ret;
    }     

    if(dscpSource == RAW_QOS_DSCP_SOURCE_INTR_PRI)
        *pType = DSCP_RMK_SRC_INT_PRI;
    else if(dscpSource == RAW_QOS_DSCP_SOURCE_ORI_DSCP)
        *pType = DSCP_RMK_SRC_DSCP;
    else
        return RT_ERR_FAILED;

    return RT_ERR_OK;
} /* end of dal_apollo_qos_dscpRemarkSrcSel_get */

/* Function Name:
 *      dal_apollo_qos_dscpRemarkSrcSel_set
 * Description:
 ...
 */
int32
dal_apollo_qos_portDscpRemarkSrcSel_set(rtk_port_t port, rtk_qos_dscpRmkSrc_t type)
{
    int32   ret;
    apollo_raw_dscp_source_t dscpSource;
    ...
    if(type == DSCP_RMK_SRC_INT_PRI)
        dscpSource = RAW_QOS_DSCP_SOURCE_INTR_PRI;
    else if(type == DSCP_RMK_SRC_DSCP)
        dscpSource = RAW_QOS_DSCP_SOURCE_ORI_DSCP;
    else
        return RT_ERR_INPUT;
        
    if ((ret = apollo_raw_qos_dscpRemarkSource_set(port, dscpSource)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_QOS), "");
        return ret;
    } 
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_qos_portDscpRemarkSrcSel_set */


/* Function Name:
 *      dal_apollo_qos_dscp2DscpRemarkGroup_get
 * Description:
 ...
 */
int32
dal_apollo_qos_dscp2DscpRemarkGroup_get(uint32 grpIdx, uint32 dscp, uint32 *pDscp)
{
    int32   ret;
    ...
    if ((ret = reg_array_field_read(RMK_DSCP_CTRLr, REG_ARRAY_INDEX_NONE, dscp, INTPRI_DSCPf, pDscp)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_QOS|MOD_DAL), "");
        return ret;
    }
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_qos_dscp2DscpRemark_get */

/* Function Name:
 *      dal_apollo_qos_dscp2DscpRemarkGroup_set
 * Description:
 ...
 */
int32
dal_apollo_qos_dscp2DscpRemarkGroup_set(uint32 grpIdx,uint32 dscp, uint32 rmkDscp)
{
    int32   ret;
    ...
    if ((ret = reg_array_field_write(RMK_DSCP_CTRLr, REG_ARRAY_INDEX_NONE, dscp, INTPRI_DSCPf, &rmkDscp)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_QOS|MOD_DAL), "");
        return ret;
    }
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_qos_dscp2DscpRemark_set */



/* Function Name:
 *      dal_apollo_qos_fwd2CpuPriRemap_get
 * Description:
 ...
 */
int32
dal_apollo_qos_fwd2CpuPriRemap_get(rtk_pri_t   intPri,
                            rtk_pri_t   *pRempPri)
{
    int32   ret;
    uint32  tmpVal;
    ...
    if ((ret = reg_array_field_read(QOS_PRI_REMAP_IN_CPUr, REG_ARRAY_INDEX_NONE, intPri, PRIf, &tmpVal)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_QOS|MOD_DAL), "");
        return ret;
    }
    *pRempPri = tmpVal;
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_qos_fwd2CpuPriRemap_get */


/* Function Name:
 *      dal_apollo_qos_fwd2CpuPriRemap_set
 * Description:
 *      Set remapped internal priority of DSCP on specified DSCP remapping group.
 * Input:
 *      intPri  -  internal priority
 ...
 */
int32
dal_apollo_qos_fwd2CpuPriRemap_set(rtk_pri_t intPri,rtk_pri_t rempPri)
{
    int32   ret;
    uint32  tmpVal;
    ...
    tmpVal = rempPri;
    if ((ret = reg_array_field_write(QOS_PRI_REMAP_IN_CPUr, REG_ARRAY_INDEX_NONE, intPri, PRIf, &tmpVal)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_QOS|MOD_DAL), "");
        return ret;
    }
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_qos_fwd2CpuPriRemap_set */
...
/* Function Name:
 *      dal_apollo_qos_schedulingQueue_get
 * Description:
 ...
 */
int32
dal_apollo_qos_schedulingQueue_get(rtk_port_t port, rtk_qos_queue_weights_t *pQweights)
{
    int32    ret;
    uint32   queueId;
    uint32   weight;
    ...
    {
        /*get queue type*/
        if ((ret = apollo_raw_qos_queueType_get(port, queueId, &type)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_DAL|MOD_QOS), "");
            return ret;
        }   

        if(type == RAW_QOS_QUEUE_STRICT)
        ...
        {
            /*get WFQ weight*/
            if ((ret = apollo_raw_qos_wfqWeight_get(port, queueId, &weight)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_QOS), "");
                return ret;
            }   
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_qos_schedulingQueue_get */

/* Function Name:
 *      dal_apollo_qos_schedulingQueue_set
 * Description:
 ...
 */
int32
dal_apollo_qos_schedulingQueue_set(rtk_port_t port, rtk_qos_queue_weights_t *pQweights)
{
    int32   ret;
    uint32   queueId;
    uint32   weight;
    ...
    for(queueId = 0;queueId < HAL_MAX_NUM_OF_QUEUE();queueId++)
    {
        ...
        {
            /*set queue type*/
            if ((ret = apollo_raw_qos_queueType_set(port, queueId, RAW_QOS_QUEUE_STRICT)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_QOS), "");
                return ret;
            }   
        ...
        {
            /*set queue type*/
            if ((ret = apollo_raw_qos_queueType_set(port, queueId, RAW_QOS_QUEUE_WFQ)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_QOS), "");
                return ret;
            }   
            /*set WFQ weightqueue*/
            if ((ret = apollo_raw_qos_wfqWeight_set(port, queueId, weight)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_QOS), "");
                return ret;
            }   
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_qos_schedulingQueue_set */
