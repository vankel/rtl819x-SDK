...
dal_apollo_trap_init(void)
{
    ...
    for(rmaMac.octet[5] = 0; rmaMac.octet[5] <= 0x2F; rmaMac.octet[5]++)
    {
        ...
        if((ret = dal_apollo_trap_rmaVlanCheckEnable_set(&rmaMac, ENABLED)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_DAL|MOD_TRAP), "");
            trap_init = INIT_NOT_COMPLETED;
            return ret;
        ...
        if((ret = dal_apollo_trap_rmaPortIsolationEnable_set(&rmaMac, ENABLED)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_DAL|MOD_TRAP), "");
            trap_init = INIT_NOT_COMPLETED;
            return ret;
        ...
        if((ret = dal_apollo_trap_rmaStormControlEnable_set(&rmaMac, ENABLED)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_DAL|MOD_TRAP), "");
            trap_init = INIT_NOT_COMPLETED;
            return ret;
        ...
        if((ret = dal_apollo_trap_rmaKeepCtagEnable_set(&rmaMac, DISABLED)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_DAL|MOD_TRAP), "");
            trap_init = INIT_NOT_COMPLETED;
            return ret;
...
/* Function Name:
 *      dal_apollo_trap_rmaVlanCheckEnable_get
 * Description:
 ...
 */
int32
dal_apollo_trap_rmaVlanCheckEnable_get(rtk_mac_t *pRmaFrame, rtk_enable_t *pEnable)
{
    int32   ret;
    uint32  regAddr;
    uint32  val;
    ...
    if ((ret = reg_field_read(regAddr, VLAN_LEAKYf, &val)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_TRAP), "");
        return ret;
    }
    ...
    *pEnable = (rtk_enable_t)!val;
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_trap_rmaVlanCheckEnable_get */

/* Function Name:
 *      dal_apollo_trap_rmaVlanCheckEnable_set
 * Description:
 ...
 */
int32
dal_apollo_trap_rmaVlanCheckEnable_set(rtk_mac_t *pRmaFrame, rtk_enable_t enable)
{
    int32   ret;
    uint32  regAddr;
    uint32  val;
    ...
    if ((ret = reg_field_write(regAddr, VLAN_LEAKYf, &val)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_TRAP), "");
        return ret;
    }
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_trap_rmaVlanCheckEnable_set */

/* Function Name:
 *      dal_apollo_trap_rmaPortIsolationEnable_get
 * Description:
 ...
 */
int32
dal_apollo_trap_rmaPortIsolationEnable_get(rtk_mac_t *pRmaFrame, rtk_enable_t *pEnable)
{
    int32   ret;
    uint32  regAddr;
    uint32  val;
    ...
    *pEnable = (rtk_enable_t)!val;
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_trap_rmaPortIsolationEnable_get */

/* Function Name:
 *      dal_apollo_trap_rmaPortIsolationEnable_set
 * Description:
 ...
 */
int32
dal_apollo_trap_rmaPortIsolationEnable_set(rtk_mac_t *pRmaFrame, rtk_enable_t enable)
{
    int32   ret;
    uint32  regAddr;
    uint32  val;
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_trap_rmaPortIsolationEnable_set */

/* Function Name:
 *      dal_apollo_trap_rmaStormControlEnable_get
 * Description:
 ...
 */
int32
dal_apollo_trap_rmaStormControlEnable_get(rtk_mac_t *pRmaFrame, rtk_enable_t *pEnable)
{
    int32   ret;
    uint32  regAddr;
    uint32  val;
    ...
    *pEnable = (rtk_enable_t)!val;
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_trap_rmaStormControlEnable_get */

/* Function Name:
 *      dal_apollo_trap_rmaStormControlEnable_set
 * Description:
 ...
 */
int32
dal_apollo_trap_rmaStormControlEnable_set(rtk_mac_t *pRmaFrame, rtk_enable_t enable)
{
    int32   ret;
    uint32  regAddr;
    uint32  val;
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_trap_rmaStormControlEnable_set */

/* Function Name:
 *      dal_apollo_trap_rmaKeepCtagEnable_get
 * Description:
 ...
 */
int32
dal_apollo_trap_rmaKeepCtagEnable_get(rtk_mac_t *pRmaFrame, rtk_enable_t *pEnable)
{
    int32   ret;
    uint32  regAddr;
    uint32  val;
    ...
    *pEnable = (rtk_enable_t)val;
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_trap_rmaKeepCtagEnable_get */

/* Function Name:
 *      dal_apollo_trap_rmaKeepCtagEnable_set
 * Description:
 ...
 */
int32
dal_apollo_trap_rmaKeepCtagEnable_set(rtk_mac_t *pRmaFrame, rtk_enable_t enable)
{
    int32   ret;
    uint32  regAddr;
    uint32  val;
    ...
    return RT_ERR_OK;
} /* end of dal_apollo_trap_rmaKeepCtagEnable_set */
