 ...
 */
cparser_result_t
cparser_cmd_qos_get_priority_selector(
    cparser_context_t *context)
{
    int32 ret = RT_ERR_FAILED;
    ...
    DIAG_UTIL_ERR_CHK(rtk_qos_priSelGroup_get(0, &weight), ret);
    ...
    return CPARSER_OK;
}    /* end of cparser_cmd_qos_get_priority_selector */

/*
 * qos set priority-selector port <UINT:weight> 
 */
cparser_result_t
cparser_cmd_qos_set_priority_selector_port_weight(
    cparser_context_t *context,
    uint32_t  *weight_ptr)
{
    int32 ret = RT_ERR_FAILED;
    ...
    DIAG_UTIL_ERR_CHK(rtk_qos_priSelGroup_set(0, &weight), ret);
     
    return CPARSER_OK;
}    /* end of cparser_cmd_qos_set_priority_selector_port_weight */

/*
 * qos set priority-selector dot1q <UINT:weight> 
 */
cparser_result_t
cparser_cmd_qos_set_priority_selector_dot1q_weight(
    cparser_context_t *context,
    uint32_t  *weight_ptr)
{
    int32 ret = RT_ERR_FAILED;
    ...
    DIAG_UTIL_ERR_CHK(rtk_qos_priSelGroup_set(0, &weight), ret);
    return CPARSER_OK;
}    /* end of cparser_cmd_qos_set_priority_selector_dot1q_weight */

/*
 * qos set priority-selector dscp <UINT:weight> 
 */
cparser_result_t
cparser_cmd_qos_set_priority_selector_dscp_weight(
    cparser_context_t *context,
    uint32_t  *weight_ptr)
{
    int32 ret = RT_ERR_FAILED;
    ...
    DIAG_UTIL_ERR_CHK(rtk_qos_priSelGroup_set(0, &weight), ret);
    return CPARSER_OK;
}    /* end of cparser_cmd_qos_set_priority_selector_dscp_weight */

/*
 * qos set priority-selector acl <UINT:weight> 
 */
cparser_result_t
cparser_cmd_qos_set_priority_selector_acl_weight(
    cparser_context_t *context,
    uint32_t  *weight_ptr)
{
    int32 ret = RT_ERR_FAILED;
    ...
    DIAG_UTIL_ERR_CHK(rtk_qos_priSelGroup_set(0, &weight), ret);
    return CPARSER_OK;
}    /* end of cparser_cmd_qos_set_priority_selector_acl_weight */

/*
 * qos set priority-selector lookup-table <UINT:weight> 
 */
cparser_result_t
cparser_cmd_qos_set_priority_selector_lookup_table_weight(
    cparser_context_t *context,
    uint32_t  *weight_ptr)
{
    int32 ret = RT_ERR_FAILED;
    ...
    DIAG_UTIL_ERR_CHK(rtk_qos_priSelGroup_set(0, &weight), ret);
    return CPARSER_OK;
}    /* end of cparser_cmd_qos_set_priority_selector_lookup_table_weight */

/*
 * qos set priority-selector smac <UINT:weight> 
 */
cparser_result_t
cparser_cmd_qos_set_priority_selector_smac_weight(
    cparser_context_t *context,
    uint32_t  *weight_ptr)
{
    int32 ret = RT_ERR_FAILED;
    ...
    DIAG_UTIL_ERR_CHK(rtk_qos_priSelGroup_set(0, &weight), ret);
    return CPARSER_OK;
}    /* end of cparser_cmd_qos_set_priority_selector_smac_weight */

/*
 * qos set priority-selector svlan <UINT:weight> 
 */
cparser_result_t
cparser_cmd_qos_set_priority_selector_svlan_weight(
    cparser_context_t *context,
    uint32_t  *weight_ptr)
{
    int32 ret = RT_ERR_FAILED;
    ...
    DIAG_UTIL_ERR_CHK(rtk_qos_priSelGroup_set(0, &weight), ret);
    return CPARSER_OK;
}    /* end of cparser_cmd_qos_set_priority_selector_svlan_weight */

/*
 * qos set priority-selector vlan <UINT:weight> 
 */
cparser_result_t
cparser_cmd_qos_set_priority_selector_vlan_weight(
    cparser_context_t *context,
    uint32_t  *weight_ptr)
{
    int32 ret = RT_ERR_FAILED;
    ...
    DIAG_UTIL_ERR_CHK(rtk_qos_priSelGroup_set(0, &weight), ret);
    return CPARSER_OK;
}    /* end of cparser_cmd_qos_set_priority_selector_vlan_weight */

/*
 * qos set priority-selector l4 <UINT:weight> 
 */
cparser_result_t
cparser_cmd_qos_set_priority_selector_l4_weight(
    cparser_context_t *context,
    uint32_t  *weight_ptr)
{
    int32 ret = RT_ERR_FAILED;
    ...
    DIAG_UTIL_ERR_CHK(rtk_qos_priSelGroup_set(0, &weight), ret);
    return CPARSER_OK;
}    /* end of cparser_cmd_qos_set_priority_selector_l4_weight */
 ...
 */
cparser_result_t
cparser_cmd_qos_set_remarking_port_ports_all_dscp_source_internal_priority_dscp(
    cparser_context_t *context,
    char * *ports_ptr)
{
    int32 ret = RT_ERR_FAILED;
 ...
 */
cparser_result_t
cparser_cmd_qos_get_remarking_dscp_source_internal_priority_dscp(
    cparser_context_t *context)
{
    int32 ret = RT_ERR_FAILED;
    rtk_qos_dscpRmkSrc_t    source;
    ...
    return CPARSER_OK;
}    /* end of cparser_cmd_qos_get_remarking_dscp_source_internal_priority_dscp */

/*
 * qos set remarking dscp inter-priority <UINT:priority> dscp <UINT:dscp>
 */
cparser_result_t
cparser_cmd_qos_set_remarking_dscp_inter_priority_priority_dscp_dscp(
    cparser_context_t *context,
    uint32_t  *priority_ptr,
    uint32_t  *dscp_ptr)
{
    ...
    return CPARSER_OK;
}    /* end of cparser_cmd_qos_set_remarking_dscp_inter_priority_priority_dscp_dscp */

/*
 * qos set remarking dscp original-dscp <MASK_LIST:dscp> remarking-dscp <UINT:remarking_dscp>
 */
cparser_result_t
cparser_cmd_qos_set_remarking_dscp_original_dscp_dscp_remarking_dscp_remarking_dscp(
    cparser_context_t *context,
    char * *dscp_ptr,
    uint32_t  *remarking_dscp_ptr)
{
    ...
    return CPARSER_OK;
}    /* end of cparser_cmd_qos_set_remarking_dscp_original_dscp_dscp_remarking_dscp_remarking_dscp */
 ...
 */
cparser_result_t
cparser_cmd_qos_set_remarking_dot1p_inter_priority_priority_dot1p_priority_dot1p_priority(
    cparser_context_t *context,
    uint32_t  *priority_ptr,
    uint32_t  *dot1p_priority_ptr)
{
    ...
    return CPARSER_OK;
}    /* end of cparser_cmd_qos_set_remarking_dot1p_inter_priority_priority_dot1p_priority_dot1p_priority */
...
#ifdef CONFIG_SDK_APOLLOMP
            case APOLLOMP_CHIP_ID:
                DIAG_UTIL_ERR_CHK(apollomp_raw_qos_queueType_get(port, *qid_ptr,&type), ret); 
                diag_util_mprintf("port: %d queue: %d type:%s\n",port,*qid_ptr,(type==APOLLOMP_QOS_QUEUE_STRICT)?DIAG_STR_QUEUE_STRICT:DIAG_STR_QUEUE_WFQ );        
                break;
#endif            
            default:
                diag_util_mprintf("%s\n",DIAG_STR_NOTSUPPORT);        
...
#ifdef CONFIG_SDK_APOLLOMP
    apollomp_raw_queue_type_t qType;
    if ('s' == TOKEN_CHAR(8,0))
        qType = APOLLOMP_QOS_QUEUE_STRICT;  /*strict*/   
    else
        qType = APOLLOMP_QOS_QUEUE_WFQ;  /*wfq*/  
#endif
...
#ifdef CONFIG_SDK_APOLLOMP
            case APOLLOMP_CHIP_ID:
                DIAG_UTIL_ERR_CHK(apollomp_raw_qos_queueType_set(port, *qid_ptr,qType), ret); 
                break;
#endif            
            default:
                diag_util_mprintf("%s\n",DIAG_STR_NOTSUPPORT);        
...
#ifdef CONFIG_SDK_APOLLOMP
            case APOLLOMP_CHIP_ID:
                DIAG_UTIL_ERR_CHK(apollomp_raw_qos_wfqWeight_get(port, qid,&weight), ret); 
                diag_util_mprintf("port: %d queue: %d weight:%d\n",port,*qid_ptr,weight);        
                break;
#endif            
            default:
...
#ifdef CONFIG_SDK_APOLLOMP
            case APOLLOMP_CHIP_ID:
                DIAG_UTIL_ERR_CHK(apollomp_raw_qos_wfqWeight_set(port, qid,weight), ret); 
                break;
#endif            
            default:
                diag_util_printf("%s\n",DIAG_STR_NOTSUPPORT);        
