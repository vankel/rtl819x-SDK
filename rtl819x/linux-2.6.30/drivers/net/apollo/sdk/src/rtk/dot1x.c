 ...
 *
 * $Revision: 20135 $
 * $Date: 2011-07-28 17:51:53 +0800 (星期四, 28 七月 2011) $
 *
...
rtk_dot1x_unauthPacketOper_get(rtk_port_t port, rtk_action_t *pUnauthAction)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->dot1x_unauthPacketOper_get( port, pUnauthAction);
    RTK_API_UNLOCK();
    return ret;
...
rtk_dot1x_unauthPacketOper_set(rtk_port_t port, rtk_action_t unauthAction)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->dot1x_unauthPacketOper_set( port, unauthAction);
    RTK_API_UNLOCK();
    return ret;
...
rtk_dot1x_portBasedEnable_get(rtk_port_t port, rtk_enable_t *pEnable)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->dot1x_portBasedEnable_get( port, pEnable);
    RTK_API_UNLOCK();
    return ret;
...
rtk_dot1x_portBasedEnable_set(rtk_port_t port, rtk_enable_t enable)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->dot1x_portBasedEnable_set( port, enable);
    RTK_API_UNLOCK();
    return ret;
...
rtk_dot1x_portBasedAuthStatus_get(rtk_port_t port, rtk_dot1x_auth_status_t *pPort_auth)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->dot1x_portBasedAuthStatus_get( port, pPort_auth);
    RTK_API_UNLOCK();
    return ret;
...
rtk_dot1x_portBasedAuthStatus_set(rtk_port_t port, rtk_dot1x_auth_status_t port_auth)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->dot1x_portBasedAuthStatus_set( port, port_auth);
    RTK_API_UNLOCK();
    return ret;
...
rtk_dot1x_portBasedDirection_get(rtk_port_t port, rtk_dot1x_direction_t *pPort_direction)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->dot1x_portBasedDirection_get( port, pPort_direction);
    RTK_API_UNLOCK();
    return ret;
...
rtk_dot1x_portBasedDirection_set(rtk_port_t port, rtk_dot1x_direction_t port_direction)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->dot1x_portBasedDirection_set( port, port_direction);
    RTK_API_UNLOCK();
    return ret;
...
rtk_dot1x_macBasedEnable_get(rtk_port_t port, rtk_enable_t *pEnable)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->dot1x_macBasedEnable_get( port, pEnable);
    RTK_API_UNLOCK();
    return ret;
...
rtk_dot1x_macBasedEnable_set(rtk_port_t port, rtk_enable_t enable)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->dot1x_macBasedEnable_set( port, enable);
    RTK_API_UNLOCK();
    return ret;
...
rtk_dot1x_macBasedDirection_get(rtk_dot1x_direction_t *pMac_direction)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->dot1x_macBasedDirection_get( pMac_direction);
    RTK_API_UNLOCK();
    return ret;
...
rtk_dot1x_macBasedDirection_set(rtk_dot1x_direction_t mac_direction)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->dot1x_macBasedDirection_set( mac_direction);
    RTK_API_UNLOCK();
    return ret;
...
rtk_dot1x_guestVlan_get( rtk_vlan_t *pGuest_vlan)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->dot1x_guestVlan_get( pGuest_vlan);
    RTK_API_UNLOCK();
    return ret;
...
rtk_dot1x_guestVlan_set(rtk_vlan_t guest_vlan)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->dot1x_guestVlan_set( guest_vlan);
    RTK_API_UNLOCK();
    return ret;
...
rtk_dot1x_guestVlanBehavior_get(rtk_dot1x_guestVlanBehavior_t *pBehavior)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->dot1x_guestVlanBehavior_get( pBehavior);
    RTK_API_UNLOCK();
    return ret;
...
rtk_dot1x_guestVlanBehavior_set(rtk_dot1x_guestVlanBehavior_t behavior)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->dot1x_guestVlanBehavior_set( behavior);
    RTK_API_UNLOCK();
    return ret;
...
rtk_dot1x_trapPri_get(rtk_pri_t *pPriority)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->dot1x_trapPri_get( pPriority);
    RTK_API_UNLOCK();
    return ret;
...
rtk_dot1x_trapPri_set(rtk_pri_t priority)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->dot1x_trapPri_set( priority);
    RTK_API_UNLOCK();
    return ret;
