 ...
 *
 * $Revision: 16212 $
 * $Date: 2011-03-10 10:39:02 +0800 (?Ÿæ??? 10 ä¸‰æ? 2011) $
 *
...
rtk_trap_reasonTrapToCpuPriority_get(rtk_trap_reason_type_t type, rtk_pri_t *pPriority)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_reasonTrapToCpuPriority_get( type, pPriority);
    RTK_API_UNLOCK();
    return ret;
...
rtk_trap_reasonTrapToCpuPriority_set(rtk_trap_reason_type_t type, rtk_pri_t priority)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_reasonTrapToCpuPriority_set( type, priority);
    RTK_API_UNLOCK();
    return ret;
...
rtk_trap_igmpCtrlPkt2CpuEnable_get(rtk_enable_t *pEnable)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_igmpCtrlPkt2CpuEnable_get( pEnable);
    RTK_API_UNLOCK();
    return ret;
...
rtk_trap_igmpCtrlPkt2CpuEnable_set(rtk_enable_t enable)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_igmpCtrlPkt2CpuEnable_set( enable);
    RTK_API_UNLOCK();
    return ret;
...
rtk_trap_mldCtrlPkt2CpuEnable_get(rtk_enable_t *pEnable)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_mldCtrlPkt2CpuEnable_get( pEnable);
    RTK_API_UNLOCK();
    return ret;
...
rtk_trap_mldCtrlPkt2CpuEnable_set(rtk_enable_t enable)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_mldCtrlPkt2CpuEnable_set( enable);
    RTK_API_UNLOCK();
    return ret;
...
rtk_trap_ipMcastPkt2CpuEnable_get(rtk_enable_t *pEnable)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_ipMcastPkt2CpuEnable_get( pEnable);
    RTK_API_UNLOCK();
    return ret;
...
rtk_trap_ipMcastPkt2CpuEnable_set(rtk_enable_t enable)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_ipMcastPkt2CpuEnable_set( enable);
    RTK_API_UNLOCK();
    return ret;
...
rtk_trap_l2McastPkt2CpuEnable_get(rtk_enable_t *pEnable)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_l2McastPkt2CpuEnable_get( pEnable);
    RTK_API_UNLOCK();
    return ret;
...
rtk_trap_l2McastPkt2CpuEnable_set(rtk_enable_t enable)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_l2McastPkt2CpuEnable_set( enable);
    RTK_API_UNLOCK();
    return ret;
...
rtk_trap_rmaAction_get(rtk_mac_t *pRmaFrame, rtk_trap_rma_action_t *pRmaAction)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_rmaAction_get( pRmaFrame, pRmaAction);
    RTK_API_UNLOCK();
    return ret;
...
rtk_trap_rmaAction_set(rtk_mac_t *pRmaFrame, rtk_trap_rma_action_t rmaAction)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_rmaAction_set( pRmaFrame, rmaAction);
    RTK_API_UNLOCK();
    return ret;
...
rtk_trap_rmaPri_get(rtk_pri_t *pPriority)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_rmaPri_get( pPriority);
    RTK_API_UNLOCK();
    return ret;
...
rtk_trap_rmaPri_set(rtk_pri_t priority)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_rmaPri_set( priority);
    RTK_API_UNLOCK();
    return ret;
 ...
 */
int32
rtk_trap_rmaVlanCheckEnable_get(rtk_mac_t *pRmaFrame, rtk_enable_t *pEnable)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_rmaVlanCheckEnable_get( pRmaFrame, pEnable);
    RTK_API_UNLOCK();
    return ret;
 ...
 */
int32
rtk_trap_rmaVlanCheckEnable_set(rtk_mac_t *pRmaFrame, rtk_enable_t enable)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_rmaVlanCheckEnable_set( pRmaFrame, enable);
    RTK_API_UNLOCK();
    return ret;
} /* end of rtk_trap_rmaVlanCheckEnable_set */

/* Function Name:
 *      rtk_trap_rmaPortIsolationEnable_get
 * Description:
 ...
 */
int32
rtk_trap_rmaPortIsolationEnable_get(rtk_mac_t *pRmaFrame, rtk_enable_t *pEnable)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_rmaPortIsolationEnable_get( pRmaFrame, pEnable);
    RTK_API_UNLOCK();
    return ret;
} /* end of rtk_trap_rmaPortIsolationEnable_get */

/* Function Name:
 *      rtk_trap_rmaPortIsolationEnable_set
 * Description:
 ...
 */
int32
rtk_trap_rmaPortIsolationEnable_set(rtk_mac_t *pRmaFrame, rtk_enable_t enable)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_rmaPortIsolationEnable_set( pRmaFrame, enable);
    RTK_API_UNLOCK();
    return ret;
} /* end of rtk_trap_rmaPortIsolationEnable_set */

/* Function Name:
 *      rtk_trap_rmaStormControlEnable_get
 * Description:
 ...
 */
int32
rtk_trap_rmaStormControlEnable_get(rtk_mac_t *pRmaFrame, rtk_enable_t *pEnable)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_rmaStormControlEnable_get( pRmaFrame, pEnable);
    RTK_API_UNLOCK();
    return ret;
} /* end of rtk_trap_rmaStormControlEnable_get */

/* Function Name:
 *      rtk_trap_rmaStormControlEnable_set
 * Description:
 ...
 */
int32
rtk_trap_rmaStormControlEnable_set(rtk_mac_t *pRmaFrame, rtk_enable_t enable)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_rmaStormControlEnable_set( pRmaFrame, enable);
    RTK_API_UNLOCK();
    return ret;
} /* end of rtk_trap_rmaStormControlEnable_set */

/* Function Name:
 *      rtk_trap_rmaKeepCtagEnable_get
 * Description:
 ...
 */
int32
rtk_trap_rmaKeepCtagEnable_get(rtk_mac_t *pRmaFrame, rtk_enable_t *pEnable)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_rmaKeepCtagEnable_get( pRmaFrame, pEnable);
    RTK_API_UNLOCK();
    return ret;
} /* end of rtk_trap_rmaKeepCtagEnable_get */

/* Function Name:
 *      rtk_trap_rmaKeepCtagEnable_set
 * Description:
 ...
 */
int32
rtk_trap_rmaKeepCtagEnable_set(rtk_mac_t *pRmaFrame, rtk_enable_t enable)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_rmaKeepCtagEnable_set( pRmaFrame, enable);
    RTK_API_UNLOCK();
    return ret;
} /* end of rtk_trap_rmaKeepCtagEnable_set */
...
rtk_trap_oamPduAction_get(rtk_action_t *pAction)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_oamPduAction_get( pAction);
    RTK_API_UNLOCK();
    return ret;
...
rtk_trap_oamPduAction_set(rtk_action_t action)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_oamPduAction_set( action);
    RTK_API_UNLOCK();
    return ret;
...
rtk_trap_oamPduPri_get(rtk_pri_t *pPriority)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_oamPduPri_get( pPriority);
    RTK_API_UNLOCK();
    return ret;
...
rtk_trap_oamPduPri_set(rtk_pri_t priority)
{
    int32   ret;
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_oamPduPri_set( priority);
    RTK_API_UNLOCK();
    return ret;
