...
#ifndef __DAL_APOLLOMP_SVLAN_H__
#define __DAL_APOLLOMP_SVLAN_H__
 ...
 * Data Declaration
 */
typedef enum dal_apollomp_svlan_priSel_e
{
    DAL_APOLLOMP_SVLAN_PRISEL_INTERNAL_PRI  = 0,
    DAL_APOLLOMP_SVLAN_PRISEL_1QTAG_PRI,
    DAL_APOLLOMP_SVLAN_PRISEL_VSPRI,
    DAL_APOLLOMP_SVLAN_PRISEL_PBPRI,
    DAL_APOLLOMP_SVLAN_PRISEL_END,    

} dal_apollomp_svlan_priSel_t;



typedef enum dal_apollomp_svlan_untag_action_e
{
    DAL_APOLLOMP_SVLAN_UNTAG_DROP = 0,
    DAL_APOLLOMP_SVLAN_UNTAG_TRAP,
    DAL_APOLLOMP_SVLAN_UNTAG_ASSIGN,
    DAL_APOLLOMP_SVLAN_UNTAG_CVID,
    DAL_APOLLOMP_SVLAN_UNTAG_END
} dal_apollomp_svlan_untag_action_t;

typedef enum dal_apollomp_svlan_unmatch_action_e
{
    DAL_APOLLOMP_SVLAN_UNMATCH_DROP = 0,
    DAL_APOLLOMP_SVLAN_UNMATCH_TRAP,
    DAL_APOLLOMP_SVLAN_UNMATCH_ASSIGN,
    DAL_APOLLOMP_SVLAN_UNMATCH_ASSIGN_KEEP,
    DAL_APOLLOMP_SVLAN_UNMATCH_END
} dal_apollomp_svlan_unmatch_action_t;

typedef enum dal_apollomp_svlan_mc2sfmt_e
{
    DAL_APOLLOMP_SVLAN_MC2S_FMT_MAC  = 0,
    DAL_APOLLOMP_SVLAN_MC2S_FMT_IP,
    DAL_APOLLOMP_SVLAN_MC2S_FMT_END,    

} dal_apollomp_svlan_mc2sfmt_t;


typedef enum dal_apollomp_svlan_lookupType_e
{
    DAL_APOLLOMP_SVLAN_LOOKUP_S64MBRCGF  = 0,
    DAL_APOLLOMP_SVLAN_LOOKUP_C4KVLAN,
    DAL_APOLLOMP_SVLAN_LOOKUP_END,

} dal_apollomp_svlan_lookupType_t;


/*
 * Macro Declaration
 */
#define DAL_APOLLOMP_SVLAN_VID_NOT_ACCEPT(vid) \
...
/* Module Name : SVLAN */
extern int32 dal_apollomp_svlan_checkAndCreate(rtk_vlan_t svid, uint32 *svidx);
...
#endif /* __DAL_APOLLOMP_SVLAN_H__ */
