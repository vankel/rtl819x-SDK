...
typedef enum rtk_reg_list_e
{
    ...
    GPON_GTC_US_EQDr,
    GPON_GTC_US_LASERr = 860,
    GPON_GTC_US_BOH_CFGr,
    GPON_GTC_US_BOH_DATAr,
    ...
    GPON_GEM_US_ETH_GEM_RX_CNTR_STATr,
    GPON_GEM_US_PTN_CTRLr,
    GPON_GEM_US_PORT_MAPr,
    GPON_GEM_US_BYTE_STATr = 880,
    TCONT_IDLE_BYTE_STATr,
...
typedef enum rtk_regField_list_e
{
    ...
    CFG_FRC_SEL_FIBf,
    CFG_FRC_SEL_FX100f,
    CFG_FRC_TX_DISABLE_OPTICf,
    CFG_FRC_TX_DISABLE_OPTIC_INVf,
    CFG_FRC_TX_OPTIC_SDf,
    CFG_FRC_TX_OPTIC_SD_INVf = 270,
    CFG_FRC_V2ANALOGf,
    CFG_FREE_CNT_SELf,
    CFG_F_CODE_RX_25Mf,
    CFG_F_CODE_RX_40Mf,
    ...
    CFG_PAR_FIELD_CTRL_05f,
    CFG_PAR_FIELD_CTRL_06f,
    CFG_PAR_FIELD_CTRL_07f,
    CFG_PAR_FIELD_CTRL_08f = 320,
    ...
    CLR_PE_MAX_PAGE_CNTf,
    CLR_Q_MAX_PAGE_CNTf,
    CLR_SOFT_RSTBf,
    CLR_TOTAL_PKTCNTf = 420,
    CMA_RQf,
    CMDf,
    CMD0_ADRf,
    CMD0_INVf,
    ...
    CNTR_DS_BIP_ERR_BITSf,
    CNTR_DS_BIP_ERR_BLOCKf,
    CNTR_FEC_CORRECTED_BITSf,
    CNTR_FEC_CORRECTED_BYTESf = 460,
    ...
    DOT3INPAUSEFRAMESf,
    DOT3LLIDRXBROADCASTFRAMESDROPf,
    ...
    DOT3STATSMULTIPLECOLLISIONFRAMESf,
    ...
    ETHERSTATSCRCALIGNERRORSf = 830,
    ETHERSTATSDROPEVENTSf,
    ...
    INTR_POLARITYf,
    INTR_STAT_GPHYf,
    INTR_STAT_PORT_CHANGEf = 1080,
    INTR_STAT_PORT_LINKDOWNf,
    ...
    LIMIT_IPG_CFGf,
    LINKBf,
    LINKDOWN_AGEOUTf = 1170,
    LINKID_EC_GATCLK_ENf,
    ...
    REG_CMU_BYPASS_PI_RXf = 1560,
    REG_CMU_BYPASS_PI_TXf,
    REG_CMU_BYPASS_R2f,
    ...
    REG_CMU_CP_TIME_GPHYf = 1570,
    REG_CMU_DIVIDE_NUM_GPHYf,
    ...
    REG_CMU_LCBIAS_LPF_EN_GPHYf = 1580,
    REG_CMU_LCVCO_TR_GPHYf,
    ...
    REG_CMU_N_PLL_GPHYf,
    REG_CMU_N_PLL_TXf,
    REG_CMU_PI_I_SEL_RXf = 1590,
    REG_CMU_PI_I_SEL_TXf,
    ...
    REG_CMU_SEL_R_GPHYf,
    REG_CMU_SEL_VCO_RXf,
    REG_CMU_SEL_VCO_TXf = 1610,
    REG_CMU_START_EN_GPHY_MANUALf,
    ...
    REG_CMU_VSEL_LDO_Df = 1620,
    REG_CMU_VSEL_LREG_GPHYf,
    ...
    REG_TX_EN_EMPHASf,
    REG_TX_EN_TESTf,
    REG_TX_EN_VCM_RESf = 1710,
    REG_TX_SEL_CKRD_DUTYf,
    REG_TX_SEL_VCMf,
    REG_TX_SWINGf,
    REG_TX_V20_SELf,
    REG_Z0_NADJRf,
    ...
    RX_ETHERSTATSPKTS1519TOMAXOCTETSf = 1800,
    RX_ETHERSTATSPKTS256TO511OCTETSf,
    ...
    RX_OK_MCf,
    RX_OK_PHYf,
    RX_PAUSE_ON_TIMER_100Mf = 1820,
    RX_PAUSE_ON_TIMER_GIGAf,
    RX_PGCNTf,
    RX_PKT_TMR_2_0f,
    RX_PKT_TMR_3f,
    RX_RATE_THR_100Mf,
    ...
    RX_SLEEP_STEP_MAXf = 1830,
    RX_SLEEP_TIMER_100Mf,
    ...
    SEL_DEGf,
    SEL_GPIOf,
    SEL_LED_FORCE_RATEf = 1890,
    SEL_LED_FORCE_VALUEf,
    SEL_LOW_RATE_BLINKf,
    SEL_MAC_LED_RATEf,
    SEL_MIIf,
    SEL_PCIE_LED_RATEf,
    ...
    STS_DRF_BIST_NOFAILf = 1970,
    STS_DRF_START_PAUSEf,
    STS_GENf,
    STS_GPIOf,
    ...
    TX_DISABLE_OPTICf = 2060,
    TX_DISABLE_OPTIC_OEf,
    TX_DONE_PORTf,
    TX_ERR_CNTf,
    ...
    TX_ETHERSTATSPKTS256TO511OCTETSf = 2070,
    TX_ETHERSTATSPKTS512TO1023OCTETSf,
