...
{  
    ...
    if ((RT_ERR_FEATURE_NOT_SUPPORTED == rtk_sec_portAttackPreventState_set(port,setState)) 
        || (RT_ERR_FEATURE_NOT_SUPPORTED == rtk_sec_portAttackPreventState_get(port,&getState)))
    {
        return RT_ERR_OK;
    }
...
{  
    ...
    /*skip not support feature*/
    if ((RT_ERR_FEATURE_NOT_SUPPORTED == rtk_sec_attackPrevent_set(attackType,setAction)) 
        || (RT_ERR_FEATURE_NOT_SUPPORTED == rtk_sec_attackPrevent_get(attackType,&getAction)))
    {
        return RT_ERR_OK;
    }
...
{  
    ...
    setThresh = maxThresh;  
    /*skip not support feature*/
    if ((RT_ERR_FEATURE_NOT_SUPPORTED == rtk_sec_attackFloodThresh_set(type,getThresh)) 
        || (RT_ERR_FEATURE_NOT_SUPPORTED == rtk_sec_attackFloodThresh_get(type,&getThresh)))
    {
        return RT_ERR_OK;
    }
