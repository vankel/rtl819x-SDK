...
unit_test_case_t unitTestCase[] =
{
   ...
   /* OAM test */
    ...
    UNIT_TEST_CASE(20008, dal_trap_rmaKeepCtagEnable_test, GRP_ALL|GRP_TRAP),
    UNIT_TEST_CASE(20009, dal_trap_rmaPortIsolationEnable_test, GRP_ALL|GRP_TRAP),
    UNIT_TEST_CASE(20010, dal_trap_rmaPri_test, GRP_ALL|GRP_TRAP),
    UNIT_TEST_CASE(20011, dal_trap_rmaStormControlEnable_test, GRP_ALL|GRP_TRAP),
    UNIT_TEST_CASE(20012, dal_trap_rmaVlanCheckEnable_test, GRP_ALL|GRP_TRAP),
