...
#define RTK_L2_IPMCAST_FLAG_SIP_USAGE       0x00000004 /* If this flag is not set, VID will be used */
#define RTK_L2_IPMCAST_FLAG_FORCE_EXT_ROUTE 0x00000008 /* Only valid when RTK_L2_IPMCAST_FLAG_DIP_ONLY is set */
#define RTK_L2_IPMCAST_FLAG_L3MC_ROUTE_EN   0x00000010 /* Only valid when RTK_L2_IPMCAST_FLAG_DIP_ONLY is set */
 ...
 */
extern int32
rtk_l2_learningCnt_get(rtk_port_t port, uint32 *pMacCnt);
 ...
 */
extern int32
rtk_l2_limitLearningCnt_get(rtk_port_t port, uint32 *pMacCnt);
 ...
 */
extern int32
rtk_l2_limitLearningCnt_set(rtk_port_t port, uint32 macCnt);
