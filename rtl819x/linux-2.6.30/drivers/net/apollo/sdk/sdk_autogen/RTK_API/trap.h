...
/*happa: reason type need to confirm*/
 ...
 */
extern int32
rtk_trap_oamPduAction_get(rtk_port_t port, rtk_action_t *pAction);
 ...
 */
extern int32
rtk_trap_oamPduAction_set(rtk_port_t port, rtk_action_t action);
