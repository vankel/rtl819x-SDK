...
found:
	...
	/*common information*/
	entry->host_ipv6_addr.v6_addr32[0] = host_ipv6_addr.v6_addr32[0];	
	entry->host_ipv6_addr.v6_addr32[1] = host_ipv6_addr.v6_addr32[1];	
	entry->host_ipv6_addr.v6_addr32[2] = host_ipv6_addr.v6_addr32[2];	
	entry->host_ipv6_addr.v6_addr32[3] = host_ipv6_addr.v6_addr32[3];
