...
#if 0	
	printk("smpboot_pc %x=%x\n", (unsigned int )&smpboot_pc, smpboot_pc);
	printk("smpboot_gp %x=%x\n", (unsigned int )&smpboot_gp, smpboot_gp);
	printk("smpboot_sp %x=%x\n", (unsigned int )&smpboot_sp, smpboot_sp);
	printk("smpboot_a0 %x=%x\n", (unsigned int )&smpboot_a0, smpboot_a0);	

#endif	
	printk("Let Core 1 pc=%x, gp=%x, sp=%x\n", pc, gp,sp);
