...
#if defined(CONFIG_RTL8881A)
	if (REG32(0xb800000c)==0x0a) { 		// Check is RTL8881AM 

		REG32(0xb8000040) = (REG32(0xb8000040)&~(0x7<<7))|(0x3<<7); //Set MUX to GPIO
		REG32(0xb800351c) = REG32(0xb800351c) & ~(0x80); //Set E7 for  Gpio
		REG32(0xb8003524) = REG32(0xb8003524) & ~(0x80); //Set E7 for Input Mode
		if((REG32(0xb8003528)&0x80) == 0x80) { //Pull high
			vp.egressUntag = 0x10;
			vp.memberPort = 0x10;
		}
	}	
