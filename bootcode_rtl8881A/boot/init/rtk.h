...
#if defined(CONFIG_KLD_FW_SIG)
	#define FW_SIGNATURE			((char *)"kdf4")	// fw signature
	#define FW_SIGNATURE_WITH_ROOT	((char *)"kdr4")	// fw signature with root fs
#else
...
#if defined(RTL8198)
#if defined(CONFIG_KLD_FW_SIG)
#define WEB_SIGNATURE           ((char *)"kdw4")
#else
